...
components:
  ...
  code-surface:
    ...
    textColor: "{colors.cream} (JetBrains Mono); syntax in coral (keywords) / teal #5DB8A6 (strings) / {colors.cream} (numbers — never a second mustard competing with the accent)"
