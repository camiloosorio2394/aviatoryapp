...
export const NIVEL_6: DocScreen[] = [
  ...
  // ── 49 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "La llamada selectiva (SELCAL, Selective Calling) permite que una estación aeronáutica alerte a una aeronave concreta mediante una señal transmitida por radio. La cabina recibe un aviso acústico y, según el equipo, también visual; la tripulación **vuelve a establecer comunicación de voz** con la estación. No es una autorización, no contiene el mensaje de control y no reemplaza la responsabilidad de mantener un medio de comunicación disponible. Su valor en vuelo oceánico es reducir la carga de escuchar constantemente el ruido de la radio de alta frecuencia (HF, High Frequency) cuando el equipo y el procedimiento regional permiten una vigilancia SELCAL.",
      },
      {
        kind: "figura",
      ...
      { kind: "sub", text: "Una alerta no equivale a identificar inequívocamente al vuelo" },
      {
        kind: "p",
        text: "La FAA advierte que los códigos SELCAL de 16 tonos pueden repetirse entre aeronaves; la coexistencia de dos aviones con el mismo código en una región es posible. La evolución a 32 tonos amplía los códigos disponibles, pero no cambia la disciplina de cabina: **comprobar que la estación usa el indicativo correcto** antes de aceptar un mensaje. El código pertenece a la aeronave y debe corresponder al plan de vuelo; un cambio de matrícula en la rotación exige actualizar los datos presentados. No se enseñará un código inventado como si fuera una asignación real.",
      },
      {
        kind: "table",
        head: ["Estado", "Qué puede concluir la tripulación", "Qué no debe concluir"],
        rows: [
          ["Aviso SELCAL recibido", "La estación intenta establecer contacto; se responde por la radio asignada.", "Que el mensaje o una autorización ya se hayan recibido."],
          ["Prueba SELCAL correcta", "Ese enlace y equipo respondieron durante la prueba con la estación.", "Que funcionarán sin vigilancia ni comprobaciones posteriores."],
          ["Enlace controlador–piloto por datos activo", "Existe un canal digital adicional para los mensajes admitidos.", "Que puede omitirse la prueba SELCAL exigida para la región."],
          ["Código posiblemente duplicado", "Debe confirmarse el indicativo exacto al responder.", "Que cualquier llamada disparada por el tono está dirigida al vuelo."],
        ],
      },
      { kind: "sub", text: "Antes del límite oceánico: prueba y transferencia" },
      {
        kind: "p",
        text: "El manual del Atlántico Norte (NAT Doc 007, edición 2026-1) exige incluir el código SELCAL en el plan de vuelo, comprobarlo con la estación pertinente **a más tardar al entrar al espacio oceánico** y completar la prueba antes de pasar a vigilancia SELCAL. En la transferencia entre áreas oceánicas se establece el contacto prescrito con la nueva estación y se obtiene su asignación de frecuencias primaria y secundaria. La circular FAA AC 91-70D aconseja probar SELCAL antes de la entrada oceánica y de nuevo en cada límite de área de control (CTA, Control Area), incluso si funciona el enlace de datos entre controlador y piloto (CPDLC, Controller–Pilot Data Link Communications). Estas son referencias para el Atlántico Norte y la operación descrita por la FAA, no un procedimiento automáticamente aplicable a Colombia.",
      },
      {
        kind: "list",
        ordered: true,
        items: [
          "**Preparar la aeronave real.** Comprobar que código SELCAL, matrícula, indicativo del vuelo y plan presentado corresponden a la aeronave despachada. Si hubo sustitución de aeronave, la información del plan debe corregirse conforme al procedimiento aplicable; no se continúa con el código de otro avión.",
          "**Contactar la estación pertinente.** Conservar las frecuencias publicadas o asignadas para el área. En la operación NAT con enlace de datos, el contacto inicial incluye pedir la comprobación SELCAL y declarar el área oceánica siguiente cuando corresponde; la estación asigna primaria y secundaria. No se selecciona una frecuencia de un ejemplo didáctico.",
          "**Observar la prueba.** La estación transmite la señal selectiva; ambos pilotos verifican que el aviso se recibe en la cabina. La tripulación confirma el resultado por voz. Si no suena, se informa el resultado real y se coordina otra prueba o el procedimiento alterno; jamás se declara satisfactoria una prueba fallida.",
          "**Establecer la vigilancia.** Solo después de una comprobación satisfactoria y conforme al procedimiento de la región, se pasa de escucha de voz continua a vigilancia SELCAL. Se mantienen equipo y radio configurados para poder recibir la alerta y responder.",
          "**Responder y cerrar.** Ante un aviso, se contacta a la estación con el indicativo del vuelo, se verifica que el mensaje va dirigido a ese indicativo y se copia y colaciona cualquier autorización conforme a las reglas normales. El piloto que vuela mantiene la autorización vigente hasta recibir una nueva autorización válida.",
        ],
      },
      {
        kind: "escenario",
        titulo: "Una alerta durante el cruce, con enlace de datos activo",
        situacion: "Caso didáctico situado en el marco del Atlántico Norte, sin vuelo, ruta, frecuencia ni código inventados. La tripulación completó una prueba SELCAL satisfactoria con la estación asignada, mantiene CPDLC operativo y recibe ahora un aviso acústico. El piloto que monitorea (PM, Pilot Monitoring) atiende las comunicaciones mientras el piloto que vuela (PF, Pilot Flying) conserva la trayectoria autorizada.",
        preguntas: [
          { q: "¿Puede suponerse que el tono anuncia una autorización de cambio de nivel?", a: "No. El tono solo solicita que la tripulación establezca contacto. El contenido debe recibirse por el medio correspondiente y cualquier cambio de nivel requiere una autorización explícita y correctamente entendida." },
          { q: "¿Qué se verifica al contestar si existe la posibilidad de códigos repetidos?", a: "El indicativo exacto que usa la estación y el destinatario del mensaje. La recepción del tono no prueba por sí sola que el mensaje sea para esta aeronave." },
          { q: "Al transferirse a la siguiente área, ¿basta con la prueba que funcionó antes?", a: "No se presupone. La guía FAA pide repetir la prueba en los límites de CTA y el procedimiento NAT exige el contacto y la comprobación pertinentes antes de mantener vigilancia selectiva con la estación sucesiva." },
        ],
        concepto: "SELCAL reduce ruido de escucha; no reduce las verificaciones de identidad, autorización ni continuidad de comunicación.",
      },
      {
        kind: "enLaOperacion",
        momento: "Cuando la alerta no se recibe o hay duda",
        texto: "Una prueba fallida elimina la base para confiar en que la estación pueda despertar a la cabina por SELCAL. La tripulación informa la falla a la estación, mantiene la escucha de voz requerida y coordina una nueva prueba o el medio alterno que corresponda a la publicación y al procedimiento del operador. Si un aviso recibido parece destinado a otro vuelo, se aclara el indicativo antes de actuar. No se silencia la HF ni se asume que CPDLC, por estar conectado, cubre automáticamente todas las obligaciones de voz.",
        pasos: [
          "Registrar estación, radio asignada, resultado de la prueba y cambio de área.",
          "No pasar a vigilancia SELCAL hasta comprobar la recepción con la estación correspondiente.",
          "Después de un aviso, responder y confirmar el indicativo antes de procesar instrucciones.",
        ],
      },
      {
        kind: "callout",
        ...
        text: "La señal selectiva no transmite un nivel, una ruta ni una separación. Solo invita a establecer contacto. La tripulación conserva la autorización vigente mientras obtiene, comprende y colaciona el mensaje real.",
      },
      {
        kind: "summary",
        title: "En pocas palabras",
        items: [
          "SELCAL produce una alerta para que la tripulación contacte a una estación aeronáutica.",
          "La prueba con la estación pertinente precede a la vigilancia SELCAL; se repite según la transferencia regional.",
          "CPDLC o voz satelital rutinarios no eliminan por sí mismos el requisito NAT de SELCAL.",
          "Un código puede coincidir con el de otra aeronave: siempre se verifica el indicativo.",
          "Si la prueba falla, se informa y se conserva la escucha o alternativa exigida; no se presume cobertura.",
        ],
      },
      {
        kind: "detalleTecnico",
