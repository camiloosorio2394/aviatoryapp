...
/** La nota de una sola vez por lección con ejemplos (guía de distintivos). */
const NOTA_EJEMPLO = "Ejemplo educativo. El distintivo de llamada de la aerolínea es real; el número de vuelo es ficticio. Los diálogos no son transcripciones de vuelos reales."
...
export const NIVEL_7: DocScreen[] = [
  // ── 51 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "En una situación no normal, la radio no es un informe de mantenimiento. El controlador necesita saber **qué sucede, qué puede hacer el avión, qué ayuda necesita la tripulación y cuál es su intención**. Primero se vuela el avión; después se transmite lo que permite actuar, con fraseología donde existe y con inglés claro donde no alcanza.",
      },
      {
        kind: "figura",
      ...
      {
        kind: "p",
        text: "**Lo viste en las lecciones 34 a 37:** cómo se arma un MAYDAY o un PAN PAN, cuándo corresponde cada uno y el combustible. Aquí se aplica a fallas concretas; la prioridad la decide el efecto, no el nombre del sistema.",
      },
      {
        kind: "fichas",
        titulo: "Qué decir en cada falla",
        columnas: 2,
        items: [
          {
            titulo: "Pasajero enfermo",
            puntosRotulo: "Qué transmitir",
            puntos: [
              "**Decir:** condición, prioridad, intención provisional y asistencia médica al llegar.",
              "**Ejemplo:** «AVIANCA 452, we have a seriously ill passenger. We are assessing a diversion. Request priority and medical assistance on arrival.»",
              "**Cuidado:** sin diagnóstico ni aeropuerto inventados.",
            ],
          },
          {
            titulo: "Olor a quemado sin fuente identificada",
            puntosRotulo: "Qué transmitir",
            puntos: [
              "**Decir:** el hecho, que la fuente no está identificada y la ayuda.",
              "**Ejemplo:** «AVIANCA 452, we have a burning smell in the cabin; the source is not identified. We need time to complete the checklist. Request vectors away from traffic.»",
              "**Cuidado:** si la amenaza crece, cambia la prioridad.",
            ],
          },
          {
            titulo: "Indicación de tren no asegurado",
            puntosRotulo: "Qué transmitir",
            puntos: [
              "**Decir:** la indicación exacta, que se interrumpe la aproximación y el tiempo necesario.",
              "**Ejemplo:** «AVIANCA 452, we have an unsafe landing gear indication. We need to discontinue the approach and complete the checklist. We will advise our intentions.»",
              "**Cuidado:** se conoce la indicación, no la posición real del tren.",
            ],
          },
          {
            titulo: "Impacto con aves",
            puntosRotulo: "Qué transmitir",
            puntos: [
              "**Decir:** el evento, el efecto confirmado y los posibles restos en la pista.",
              "**Ejemplo:** «AVIANCA 452, we had a bird strike after departure. We are assessing an engine indication. There may be debris on the runway. Request time to evaluate.»",
              "**Cuidado:** no declarar un motor fallado sin evidencia.",
            ],
          },
          {
            titulo: "Alerta hidráulica",
            puntosRotulo: "Qué transmitir",
            puntos: [
              "**Decir:** el problema, la capacidad actual y el tiempo requerido.",
              "**Ejemplo:** «AVIANCA 452, we have a hydraulic system warning. Flight controls are responding normally at present. Request time to complete the checklist.»",
              "**Cuidado:** «at present» avisa que la capacidad puede cambiar.",
            ],
          },
        ],
      },
      ...
      {
        kind: "p",
        text: "El 15 de enero de 2009, el vuelo **US Airways 1549**, de LaGuardia a Charlotte, perdió casi todo el empuje tras impactar aves y acuatizó en el Hudson. El informe NTSB/AAR-10/03 describe cómo la tripulación cambió su evaluación sobre regresar a LaGuardia. La enseñanza: **ATC solo puede coordinar alternativas compatibles con la capacidad que la tripulación va comunicando**. La historieta de arriba no reproduce ese vuelo.",
      },
      {
        kind: "escenario",
      ...
      },
      {
        ...
        items: [
          "Primero se vuela el avión y se reparten las tareas.",
          "ATC necesita naturaleza, capacidad, ayuda requerida e intención.",
          "MAYDAY o PAN PAN (lecciones 34 a 37) dependen del efecto, no del nombre de la falla.",
          "Cuando cambia la capacidad del avión, se actualiza la intención.",
        ],
      },
      {
        kind: "detalleTecnico",
        etiqueta: "Más ejemplos",
        cita: "Desvío por meteorología · lección 25",
        bloques: [
          { kind: "p", text: "**Meteorología en la trayectoria.** Una célula bloquea el tramo autorizado. Decir que la ruta actual es inviable, el lado preferido y la petición concreta. El desvío se solicita, no se anuncia como hecho; los límites salen de la respuesta de ATC y de las contingencias publicadas." },
          { kind: "code", text: "PILOT: AVIANCA 452, unable to continue on the assigned track due weather. Request deviation to the right. We will advise the extent required." },
        ],
      },
      {
        kind: "detalleTecnico",
        etiqueta: "Más detalle",
        cita: "Las cuatro preguntas y la secuencia de cabina",
        bloques: [
          {
            kind: "table",
      ...
      },
      {
        ...
        bloques: [
          ...
          { kind: "p", text: "OACI, Doc 9835, 2.ª edición, §§3.3.13 a 3.3.17: uso de lenguaje común cuando la fraseología no cubre lo inesperado y sus exigencias de claridad. Documento oficial de OACI, no una fraseología local: https://www4.icao.int/aelts/uploads/icao%20doc9835%202nd%20edition.pdf" },
  ...
  // ── 52 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Hablar de una condición no normal en inglés no es recitar términos de sistemas: es **convertir la evaluación de cabina en información que ATC pueda usar sin adivinar**. La fraseología sigue siendo obligatoria para sus elementos; el lenguaje común cubre el hecho inesperado, las limitaciones y la ayuda. Frases cortas, despacio y con valores confirmados.",
      },
      {
        kind: "figura",
      ...
      { kind: "sub", text: "Lo que exige el Doc 9835" },
      {
        kind: "p",
        text: "El Doc 9835 de la OACI reconoce que los problemas técnicos, médicos o de seguridad pueden exigir lenguaje común, y le pide **inteligibilidad, franqueza, pertinencia, ausencia de ambigüedad y concisión**. No se convierte una sospecha («quizá el tren no bajó») en certeza, ni una incapacidad («no podemos mantener este nivel») en preferencia.",
      },
      {
        kind: "table",
      ...
      {
        kind: "p",
        text: "Las cuatro preguntas son una herramienta del curso, no fraseología publicada; en la lección 51 las aplicaste a fallas concretas. Si hay socorro o urgencia, MAYDAY o PAN PAN y la naturaleza van primero, sin esperar la plantilla.",
      },
      { kind: "sub", text: "Caso real documentado: Avianca 052" },
      {
        kind: "p",
        text: "El 25 de enero de 1990, el vuelo **Avianca 052**, de Bogotá a Nueva York con escala en Medellín, agotó el combustible después de esperas y un intento de aproximación; 73 personas fallecieron. El informe NTSB/AAR-91/04 atribuyó el accidente a varios factores, entre ellos la gestión del combustible y **no comunicar oportunamente a ATC una emergencia de combustible**; también señaló deficiencias de gestión de flujo y la falta de terminología estandarizada y comprensible entonces. La lección de comunicación no borra las demás causas: si la situación requiere trato de emergencia, se expresa con prioridad inequívoca y se comprueba que cabina y ATC entienden lo mismo.",
      },
      {
        kind: "escenario",
      ...
      },
      {
        ...
        items: [
          ...
          "Avianca 052 muestra por qué la prioridad debe llegar inequívoca a ATC.",
        ],
      },
      {
        kind: "detalleTecnico",
        etiqueta: "Más detalle",
        cita: "Pedir tiempo y explicar límites",
        bloques: [
          {
            kind: "p",
      ...
      },
      {
        ...
        bloques: [
          { kind: "p", text: "OACI, Doc 9835, 2.ª edición, §§3.3.13 a 3.3.17 y 5.3.3: inglés común en situaciones imprevistas, comunicación directa y carga cognitiva; la plantilla visual es didáctica, no un texto OACI: https://www4.icao.int/aelts/uploads/icao%20doc9835%202nd%20edition.pdf" },
  ...
  // ── 53 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "Son definiciones del glosario Pilot/Controller de la FAA; las palabras normalizadas están en la lección 11. CONFIRM sirve para pedir que se verifique un dato que se cree haber oído, no como sustituto universal de SAY AGAIN. Lo decisivo es **decir cuál dato se cuestiona** y esperar una respuesta inequívoca.",
      },
      { kind: "sub", text: "Así suena: se perdió el nivel" },
      {
        kind: "code",
        text: "ATC: AVIANCA 452, DESCEND TO FLIGHT LEVEL (tapado por otra transmisión)\nPILOT: AVIANCA 452, SAY AGAIN ALL AFTER DESCEND\nATC: AVIANCA 452, I SAY AGAIN, DESCEND TO FLIGHT LEVEL ONE EIGHT ZERO\nPILOT: DESCEND TO FLIGHT LEVEL ONE EIGHT ZERO, AVIANCA 452",
      },
      { kind: "p", text: "Se pide solo lo que faltó y se colacionan el valor y el indicativo. " + NOTA_EJEMPLO },
      { kind: "sub", text: "Detectar, preguntar, cerrar" },
      {
        kind: "list",
        ordered: true,
        items: [
          "**Detectar.** Quien monitorea marca el nivel, rumbo, pista o límite que no llegó. Si los pilotos discrepan, se pregunta; no se decide por mayoría.",
          "**Conservar.** Se mantiene la última autorización válida; no se carga un valor adivinado.",
          "**Preguntar la parte dudosa.** SAY AGAIN general si se perdió todo el mensaje; si no, el elemento concreto.",
          "**Escuchar completo.** Anotar la respuesta; si la duda sigue, preguntar otra vez. El silencio no es acuerdo.",
          "**Colacionar y cerrar.** Con el indicativo (lección 12); si ATC corrige, confirmar antes de ejecutar.",
        ],
      },
      {
        kind: "callout",
      ...
      {
        kind: "p",
        text: "Si se oyó mal, se pide repetición; no se colaciona la interpretación más probable. Si se oyó bien pero no puede cumplirse (performance, configuración, combustible), se dice UNABLE y se pide alternativa. Si todavía no se sabe, STAND BY, y luego se vuelve con la respuesta.",
      },
      {
        kind: "escenario",
      ...
      },
      {
        kind: "detalleTecnico",
        etiqueta: "Más detalle",
        cita: "FAA Pilot/Controller Glossary · OACI Doc 9835",
        bloques: [
          { kind: "p", text: "El glosario Pilot/Controller de la Administración Federal de Aviación de Estados Unidos (FAA; Federal Aviation Administration) define SAY AGAIN, UNABLE, STAND BY y ROGER. No se enseña VERIFY como palabra de aplicación libre: su sentido depende del contexto y del procedimiento publicado." },
          { kind: "p", text: "La FAA AIM §4-4-7 pide colacionar números asignados, rumbos e instrucciones de pista, entre otros elementos críticos, con el indicativo." },
  ...
  // ── 54 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "El Doc 9835 de la OACI distingue acento de inteligibilidad: no hay un acento correcto; la pronunciación debe ser comprensible. Una transmisión también se degrada por ruido, estática, micrófono recortado, velocidad o voces solapadas. Antes de culpar al acento, identificar **qué parte de la señal faltó**.",
      },
      {
        kind: "table",
      ...
      {
        kind: "p",
        text: "Conocer la fase ayuda a escuchar: tras la salida vienen nivel, rumbo y frecuencia; en rodaje, pista y límites. El riesgo es **oír lo que se esperaba** (lección 55). En la nota se separa lo recibido con certeza de lo parcial o no recibido: solo lo primero se colaciona; lo demás se pregunta como en la lección 53.",
      },
      {
        kind: "escenario",
      ...
      },
      {
        ...
        text: "Pedir una repetición clara es más competente que responder rápido con una lectura convincente pero incorrecta.",
      },
      {
        kind: "summary",
        title: "En pocas palabras",
      ...
      },
      {
        kind: "detalleTecnico",
        etiqueta: "Más detalle",
        cita: "Escucha en cabina y estrategias del Doc 9835",
        bloques: [
          {
            kind: "p",
      ...
      },
      {
        ...
        bloques: [
          { kind: "p", text: "OACI, Doc 9835, 2.ª edición, §§3.3, 4.5 a 4.6 y 5.3: inteligibilidad del acento, condiciones de radiotelefonía, estrategias para detectar y resolver malentendidos: https://www4.icao.int/aelts/uploads/icao%20doc9835%202nd%20edition.pdf" },
  ...
  // ── 55 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "El Doc 9835 de la OACI advierte que las expectativas pueden alterar la interpretación. El boletín FAA ATPB 2025-01 describe el sesgo de expectativa en controladores, pilotos y personal de superficie: puede contribuir a fallas de colación y de escucha, y el análisis de incursiones de pista lo identifica como factor importante en desviaciones de pilotos.",
      },
      {
        kind: "table",
      ...
      {
        kind: "p",
        text: "En tres puntos: la escucha reemplaza el dato por el del briefing; la colación repite el esperado con voz segura (y el controlador puede no notarlo); o, con la colación correcta, se selecciona el valor pedido. Por eso hacen falta **dos verificaciones**: la colación y el cotejo del selector con lo autorizado (lecciones 59 y 60).",
      },
      {
        kind: "escenario",
      ...
      },
      {
        kind: "detalleTecnico",
        etiqueta: "Más detalle",
        cita: "FAA ATPB 2025-01 · barreras de cabina",
        bloques: [
          {
            kind: "p",
      ...
      },
      {
        ...
        bloques: [
          { kind: "p", text: "OACI, Doc 9835, 2.ª edición, §§4.5.3 a 4.6.6: expectativa, comprensión ante lo inesperado y estrategias de aclaración: https://www4.icao.int/aelts/uploads/icao%20doc9835%202nd%20edition.pdf" },
  ...
  // ── 56 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Dos vuelos pueden compartir números o sonidos en una frecuencia. Si la tripulación reconoce solo el final del indicativo y esperaba una autorización, puede colacionar una instrucción ajena y cambiar nivel, rumbo o movimiento **sin autorización para ese avión**. La defensa: escuchar el distintivo completo, no responder «por si acaso» y no actuar mientras el destinatario sea incierto.",
      },
      {
        kind: "figura",
      ...
      { kind: "sub", text: "Un ejemplo oficial" },
      {
        kind: "p",
        text: "La orden FAA JO 7110.65 §2-4-15 pide a los controladores enfatizar los elementos distintivos, **no abreviar identificaciones que suenen parecido** y avisar a los pilotos afectados. Su ejemplo usa United Thirty-one y Alaska Thirty-one en una misma frecuencia. Es norma estadounidense, no evidencia de que esos vuelos operen hoy juntos.",
      },
      { kind: "sub", text: "Así suena: 452, 425 y 542" },
      {
        kind: "code",
        text: "ATC: AVIANCA 425, CLIMB TO FLIGHT LEVEL TWO FOUR ZERO\n(en AVIANCA 452 solo se oyó «…four… climb…»)\nPILOT: AVIANCA 452, CONFIRM CLIMB IS FOR AVIANCA 452\nATC: AVIANCA 452, NEGATIVE, MAINTAIN FLIGHT LEVEL TWO TWO ZERO. THE CLIMB WAS FOR AVIANCA 425",
      },
      { kind: "p", text: "AVIANCA 452, 425 y 542 comparten prefijo y dígitos. Quien no oyó el número completo no colaciona: pregunta y mantiene su nivel. " + NOTA_EJEMPLO },
      {
        kind: "table",
      ...
      },
      {
        kind: "callout",
        tone: "warn",
        title: "No copiar una técnica FAA como regla local",
        text: "El §2-4-15 es una orden estadounidense. En una dependencia colombiana rigen la fraseología y la AIP/eAIP de Aerocivil; esta lección no crea un procedimiento nuevo.",
      },
      {
        kind: "summary",
        title: "En pocas palabras",
        items: [
          ...
          "Indicativo completo al escuchar y al colacionar; la duda se resuelve antes de actuar.",
          "ATC puede advertir la similitud, pero la tripulación mantiene su propia barrera.",
        ],
      },
      {
        kind: "detalleTecnico",
  ...
  // ── 57 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "La FAA AIM §4-2-2 pide escuchar antes de transmitir, hacer una pausa breve tras pulsar para no perder la primera palabra, esperar antes de repetir una llamada y comprobar que el propio micrófono no quedó trabado. Cómo pedir la repetición está en la lección 53.",
      },
      { kind: "sub", text: "Caso documentado: Tenerife, 27 de marzo de 1977" },
      {
        kind: "p",
        text: "La FAA conserva una copia del informe español del accidente de Los Rodeos. En los segundos previos a la colisión entre los Boeing 747 de KLM y Pan Am, la torre y Pan Am transmitieron casi a la vez, y la superposición produjo en la cabina de KLM un ruido que afectó la recepción de una comunicación crítica. **No fue la única causa**: el informe analiza el inicio del despegue sin autorización expresa, fraseología ambigua, visibilidad reducida y decisiones de cabina. No se recrea la grabación.",
      },
      {
        kind: "escenario",
      ...
      },
      {
        kind: "detalleTecnico",
        etiqueta: "Más detalle",
        cita: "FAA AIM §4-2-2 · Recuperar una autorización",
        bloques: [
          {
            kind: "p",
      ...
      },
      {
        ...
        bloques: [
          ...
          { kind: "p", text: "Informe oficial español sobre la colisión de Los Rodeos, copia alojada por FAA, pp. 46 a 50: secuencia de comunicaciones simultáneas y análisis de factores: https://www.faa.gov/sites/faa.gov/files/2022-11/Spanish_AccReport.pdf" },
  ...
  // ── 58 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Cabina estéril no es silencio absoluto: en las fases críticas, la atención se reserva para operar el avión. Una llamada de ATC, un aviso de pista o una condición anormal sí son esenciales; una charla ajena al vuelo o una pregunta administrativa pueden esperar. La finalidad es **preservar capacidad para volar, escuchar, colacionar y verificar**.",
      },
      {
        kind: "figura",
      ...
      {
        kind: "p",
        text: "En Estados Unidos, **14 CFR §121.542** prohíbe las actividades no esenciales en fases críticas: rodaje, despegue, aterrizaje y operaciones por debajo de 10 000 pies, salvo crucero. **Esa definición es estadounidense**: en Colombia rigen los RAC y el manual del explotador, que deben consultarse.",
      },
      {
        kind: "table",
      ...
      {
        kind: "p",
        text: "Si una conversación interna tapa el final de una instrucción de rodaje, se retiene la calle y se pierde el límite de espera. La defensa: **mantener la autorización confirmada y pedir repetición del elemento perdido** (lección 53).",
      },
      { kind: "sub", text: "Caso real documentado: Colgan Air 3407" },
      {
        kind: "p",
        text: "El 12 de febrero de 2009, el vuelo **Colgan Air 3407** perdió el control durante una aproximación a Buffalo. La NTSB determinó como causa probable la respuesta inapropiada del comandante a la activación del avisador de pérdida y, entre los factores contribuyentes, que la tripulación **no siguió los procedimientos de cabina estéril**. El caso no demuestra que se perdiera una llamada de ATC: muestra cómo la distracción consume el monitoreo en una fase crítica.",
      },
      {
        kind: "escenario",
  ...
  // ── 59 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "La circular FAA AC 120-71B pide que cada operador defina las funciones PF y PM: el PF gestiona la trayectoria, incluso con piloto automático; el PM monitorea trayectoria, estado, autorizaciones e instrucciones. Un cambio de roles se hace con **asignación y aceptación verbal**. Es orientación estadounidense, no un SOP colombiano.",
      },
      {
        kind: "table",
      ...
      {
        kind: "p",
        text: "Externo: **ATC → tripulación → colación → corrección**. Interno: **dato recibido → selección → comportamiento del avión → verificación cruzada**. El PM puede colacionar bien y el selector quedar con lo solicitado. Por eso el PF no se desconecta de la radio porque otro transmite; el ciclo completo está en la lección 60.",
      },
      {
        kind: "escenario",
      ...
      },
      {
        kind: "detalleTecnico",
        etiqueta: "Más detalle",
        cita: "FAA AC 120-71B · reparto en cabina",
        bloques: [
          {
            kind: "p",
  ...
  // ── 60 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Recibir una autorización no es una sola acción: hay que **oír, interpretar, colacionar, seleccionar, cotejar, ejecutar y monitorear**. Una colación exacta (lección 12) no prueba que el sistema quedó con el valor correcto ni que el avión seguirá la trayectoria. El ciclo es del curso; el orden práctico y el reparto de tareas los define el explotador.",
      },
      {
        kind: "figura",
      ...
      {
        kind: "p",
        text: "La FAA AIM §4-4-7 pide colacionar rumbos, altitudes y autorizaciones de pista, y el controlador corrige lo que detecte. Pero ATC no ve el selector: la cabina coteja lo seleccionado y vigila la respuesta del avión.",
      },
      {
        kind: "table",
      ...
      {
        kind: "p",
        text: "Un nivel puede venir condicionado a pasar un punto o a una instrucción posterior. Hay que separar **valor** de **disparador**: preseleccionar según el SOP no vuelve inmediata una instrucción futura, y una autorización de ruta no incluye entrar en la pista.",
      },
      {
        kind: "escenario",
  ...
  // ── 61 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Los errores de comunicación no se reducen a «hablar mal inglés». Una instrucción puede ir a otro avión, llegar incompleta, colacionarse mal, corregirse sin que la cabina lo note o ejecutarse con otro valor. La competencia clave es ubicar **en qué etapa se perdió la información y qué barrera la detecta**. Esta es la lección de referencia de errores del módulo.",
      },
      {
        kind: "figura",
      ...
      { kind: "sub", text: "Palabras que no dicen lo que parece" },
      {
        kind: "table",
        head: ["Hábito", "Por qué falla", "Defensa"],
        rows: [
          ...
          ["«Ready for take-off» antes del permiso", "La palabra TAKEOFF puede escucharse fuera de una autorización real.", "Informar listo para salida según la fraseología local; reservar TAKEOFF para la autorización o su cancelación."],
        ],
      },
      {
        kind: "escenario",
      ...
      },
      {
        kind: "detalleTecnico",
        etiqueta: "Más detalle",
        cita: "FAA AIM §4-4-7 · FAA JO 7110.65 §2-4-3 · OACI Doc 9835",
        bloques: [
          {
            kind: "p",
          ...
          { kind: "sub", text: "AFFIRM y «Affirmative»" },
          { kind: "p", text: "La guía de fraseología de OACI usa AFFIRM como respuesta afirmativa normalizada; la Aeronautical Information Manual de la FAA admite «Affirmative» entre las respuestas de acuse de su sistema. Se usa el término del Estado donde se opera; no se enseña una variante estadounidense como si fuera regla OACI, ni se mezclan sin aviso." },
          {
            kind: "enLaOperacion",
