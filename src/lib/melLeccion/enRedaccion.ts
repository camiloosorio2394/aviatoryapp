...
export const EN_REDACCION: DocBlockData = {
  ...
  text: "El contenido de esta lección todavía se está escribiendo y se revisa contra las MMEL y el reglamento antes de publicarse. Por ahora no cuenta como leída: cuando esté lista, aparece aquí en su lugar.",
}
