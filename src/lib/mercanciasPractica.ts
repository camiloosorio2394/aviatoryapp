...
export const EJERCICIOS_ETIQUETAS: EjercicioEtiquetas[] = [
  {
    ...
    rondas: [
      { enunciado: "¿Qué clase o división es?", imagen: "3", opciones: [t("4.1"), t("3"), t("2.1"), t("5.1")], correcta: 1, explicacion: "Símbolo (llama) en negro o blanco sobre fondo rojo: líquido inflamable, clase 3." },
      { enunciado: "¿Qué clase o división es?", imagen: "2-2", opciones: [t("2.1"), t("2.3"), t("2.2"), t("9")], correcta: 2, explicacion: "Fondo verde: gas no inflamable, no tóxico, división 2.2." },
      { enunciado: "¿Qué clase o división es?", imagen: "4-3", opciones: [t("4.1"), t("4.3"), t("2.2"), t("4.2")], correcta: 1, explicacion: "Fondo azul: sustancia que en contacto con el agua emite gas inflamable, división 4.3." },
      { enunciado: "¿Qué clase o división es?", imagen: "5-1", opciones: [t("5.2"), t("3"), t("5.1"), t("2.1")], correcta: 2, explicacion: "Llama sobre un círculo, fondo amarillo, «5.1» en el ángulo inferior: comburente." },
      { enunciado: "¿Qué clase o división es?", imagen: "6-1", opciones: [t("6.2"), t("2.3"), t("8"), t("6.1")], correcta: 3, explicacion: "Calavera y tibias sobre fondo blanco con el «6» abajo: sustancia tóxica, división 6.1. La 2.3 lleva el mismo símbolo pero con el «2»." },
      { enunciado: "¿Qué clase o división es?", imagen: "8", opciones: [t("8"), t("6.1"), t("9"), t("4.2")], correcta: 0, explicacion: "Líquido goteando sobre una mano y una plancha, mitad superior blanca y mitad inferior negra: corrosivo, clase 8." },
      { enunciado: "¿Qué clase o división es?", imagen: "9", opciones: [t("4.1"), t("9"), t("8"), t("6.2")], correcta: 1, explicacion: "Siete franjas verticales negras en la mitad superior, fondo blanco: mercancías peligrosas varias, clase 9. Aquí van las baterías de litio y el hielo seco." },
      ...
      { enunciado: "¿Qué clase o división es?", imagen: "4-2", opciones: [t("4.3"), t("4.2"), t("3"), t("4.1")], correcta: 1, explicacion: "Mitad superior blanca y mitad inferior roja, llama en negro: sustancia susceptible de combustión espontánea, división 4.2." },
    ],
  },
  {
    id: "criterio",
    ...
    rondas: [
      ...
      { enunciado: "Sin ser de por sí necesariamente combustible, puede, liberando oxígeno, causar o facilitar la combustión de otras sustancias.", opciones: [img("5-2"), img("5-1"), img("3"), img("2-1")], correcta: 1, explicacion: "División 5.1, comburente: llama sobre un círculo, fondo amarillo. No arde ella: hace arder a las demás." },
      { enunciado: "Líquidos que despiden vapores inflamables a temperaturas que no exceden de 60,5 °C en crisol cerrado.", opciones: [img("4-1"), img("2-1"), img("3"), img("5-2")], correcta: 2, explicacion: "Clase 3, líquidos inflamables: llama sobre fondo rojo. El punto de inflamación es el criterio." },
      { enunciado: "Gases no inflamables, no tóxicos.", opciones: [img("2-1"), img("2-2"), img("2-3"), img("9")], correcta: 1, explicacion: "División 2.2: fondo verde. Es la única de las tres de gases que no lleva llama ni calavera." },
      { enunciado: "Puede calentarse espontáneamente en las condiciones normales de transporte o al entrar en contacto con el aire, y entonces inflamarse.", opciones: [img("4-3"), img("4-1"), img("4-2"), img("5-1")], correcta: 2, explicacion: "División 4.2: mitad superior blanca, mitad inferior roja." },
      { enunciado: "Se sabe o se cree fundadamente que contiene agentes patógenos que pueden causar enfermedades en los humanos o los animales.", opciones: [img("6-1"), img("6-2"), img("8"), img("9")], correcta: 1, explicacion: "División 6.2, infecciosa: tres medias lunas sobre un círculo y la inscripción de aviso a las autoridades sanitarias." },
      { enunciado: "Por su acción química causa lesiones graves al entrar en contacto con tejidos vivos, o daña de consideración otras mercancías o el medio de transporte.", opciones: [img("6-1"), img("9"), img("8"), img("4-2")], correcta: 2, explicacion: "Clase 8, corrosivas. Doble criterio: tejidos vivos y carga o aeronave." },
