...
export const EJERCICIOS_ETIQUETAS: EjercicioEtiquetas[] = [
  ...
  },
  {
    ...
    rondas: [
      ...
      { enunciado: "¿Cuál es la 2.3, gas tóxico?", opciones: [img("2-3"), img("2-2")], correcta: 0, explicacion: "La 2.2 es verde con la botella; la 2.3 es blanca con calavera y tibias, como la 6.1 pero con el «2»." },
  ...
  },
  {
    ...
    rondas: [
      ...
      { enunciado: "Una botella de gas en negro o blanco.", opciones: [t("2.1"), t("2.3"), t("2.2"), t("3")], correcta: 2, explicacion: "Gas no inflamable, no tóxico, división 2.2, sobre fondo verde. La 2.1 lleva llama y la 2.3, calavera." },
      {
        ...
        opciones: [{ texto: "Solo la 6.1" }, { texto: "La 6.1, la 6.2 y la 2.3" }, { texto: "La 6.1 y la 2.3" }],
        correcta: 2,
  ...
  },
  {
    ...
    rondas: [
      ...
      { enunciado: "Un bulto con etiqueta de división 1.1 o 1.2, ¿se transporta por vía aérea?", opciones: [{ texto: "Sí, en aeronave de carga" }, { texto: "Sí, si va segregado" }, { texto: "Normalmente no" }], correcta: 2, explicacion: "La advertencia va en la etiqueta: normalmente esos bultos no pueden transportarse por vía aérea." },
      { enunciado: "¿Y los que llevan las etiquetas de las divisiones 1.5 y 1.6?", opciones: [{ texto: "Sí, sin condiciones" }, { texto: "Normalmente tampoco" }, { texto: "Solo con etiqueta CAO" }], correcta: 1, explicacion: "Llevan la misma advertencia: normalmente no se transportan por vía aérea." },
  ...
  },
  {
    ...
    rondas: [
      ...
      { enunciado: "¿Lleva grupo de embalaje la clase 2?", opciones: [{ texto: "Sí, las tres divisiones" }, { texto: "Solo la 2.3" }, { texto: "No" }], correcta: 2, explicacion: "No. La clase 2 no tiene grupo de embalaje, como tampoco lo tienen la clase 1 y la clase 7." },
      { enunciado: "La 2.2, ¿qué símbolo y qué fondo lleva?", opciones: [{ texto: "Botella de gas sobre fondo verde" }, { texto: "Llama sobre fondo verde" }, { texto: "Botella de gas sobre fondo azul" }], correcta: 0, explicacion: "Símbolo (botella de gas) en negro o blanco, fondo verde." },
  ...
  },
  {
    ...
    rondas: [
      { enunciado: "¿Qué propiedad clasifica a un líquido en la clase 3?", opciones: [{ texto: "Su densidad" }, { texto: "Su número ONU" }, { texto: "Su punto de inflamación" }], correcta: 2, explicacion: "Despide vapores inflamables a temperaturas que no exceden de 60,5 °C en crisol cerrado. Lo que clasifica es la propiedad, no el nombre comercial del producto." },
      ...
      { enunciado: "¿Lleva grupo de embalaje la clase 4?", opciones: [{ texto: "No, ninguna división" }, { texto: "Sí, salvo las sustancias de reacción espontánea de la 4.1" }, { texto: "Solo la 4.3" }], correcta: 1, explicacion: "La clase 4 lleva grupo de embalaje, salvo las sustancias de reacción espontánea de la división 4.1." },
    ],
  },
  {
    id: "clase5",
  ...
  },
  {
    ...
    rondas: [
      ...
      { enunciado: "¿Qué símbolo lleva la 6.2?", opciones: [{ texto: "Calavera y tibias" }, { texto: "Un trébol" }, { texto: "Tres medias lunas sobre un círculo" }], correcta: 2, explicacion: "Tres medias lunas sobre un círculo, en negro sobre fondo blanco, con el «6» en el ángulo inferior." },
      { enunciado: "La 6.2 lleva una inscripción en la parte superior. ¿A quién manda advertir?", opciones: [{ texto: "A las autoridades sanitarias" }, { texto: "Al expedidor" }, { texto: "Al comandante" }], correcta: 0, explicacion: "«Sustancia infecciosa. En caso de averías o fugas, adviértase inmediatamente a las autoridades sanitarias»." },
      { enunciado: "¿Lleva grupo de embalaje la clase 6?", opciones: [{ texto: "No" }, { texto: "Sí, salvo la división 6.2" }, { texto: "Solo la 6.2" }], correcta: 1, explicacion: "La clase 6 lleva grupo de embalaje, salvo la división 6.2." },
      { enunciado: "¿Qué número lleva la 6.2 en el ángulo inferior?", opciones: [{ texto: "6" }, { texto: "6.2" }, { texto: "Ninguno" }], correcta: 0, explicacion: "El «6». La división se reconoce por el símbolo y la inscripción, no por un número distinto." },
    ],
  },
  {
    id: "clase7",
    ...
    rondas: [
      ...
      { enunciado: "¿Qué determina la categoría de la etiqueta?", opciones: [{ texto: "La cantidad de material" }, { texto: "El tipo de aeronave" }, { texto: "El nivel de radiación en la superficie del bulto y el índice de transporte" }], correcta: 2, explicacion: "A mayor categoría, mayores son las condiciones de control aplicables." },
  ...
  },
  {
    ...
    rondas: [
      ...
      { enunciado: "¿Qué dos etiquetas llevan siete franjas verticales?", opciones: [{ texto: "La clase 8 y la clase 9" }, { texto: "La 4.1 y la clase 9" }, { texto: "La 6.2 y la clase 9" }], correcta: 1, explicacion: "La 4.1 las lleva rojas y en toda la etiqueta; la clase 9, negras y solo en la mitad superior." },
      { enunciado: "Baterías de litio, hielo seco, material magnetizado, motores de combustión interna y asbesto.", opciones: [{ texto: "Clase 8" }, { texto: "Clase 4" }, { texto: "Clase 9" }], correcta: 2, explicacion: "Todos son ejemplos de la clase 9: presentan un riesgo distinto de los de las demás clases." },
  ...
  },
  {
    ...
    rondas: [
      ...
      { enunciado: "Símbolo blanco sobre fondo verde, 74 × 105 mm.", opciones: [{ texto: "Material magnetizado" }, { texto: "Gas no inflamable, 2.2" }, { texto: "Líquidos criogénicos" }], correcta: 2, explicacion: "Líquidos criogénicos: su uso es obligatorio cuando se manipulen. No la confundas con el rombo verde de la 2.2, que sí es de riesgo." },
      { enunciado: "¿A qué etiquetas de riesgo acompaña «Manténgase alejado del calor»?", opciones: [{ texto: "A la clase 8 y a la clase 9" }, { texto: "A la 4.1 de reacción espontánea y a la 5.2" }, { texto: "A la 2.2 y a la 2.3" }], correcta: 1, explicacion: "Son las que la norma asocia a ese cuidado." },
  ...
  },
  {
    ...
    rondas: [
      { enunciado: "¿Qué etiqueta mide 120 × 110 mm?", opciones: [{ texto: "Exclusivamente en aeronaves de carga" }, { texto: "Material magnetizado" }, { texto: "Posición del bulto" }], correcta: 0, explicacion: "La CAO, en negro sobre fondo anaranjado." },
      { enunciado: "¿Y cuál mide 110 × 90 mm?", opciones: [{ texto: "Líquidos criogénicos" }, { texto: "Posición del bulto" }, { texto: "Material magnetizado" }], correcta: 2, explicacion: "Material magnetizado, en azul sobre fondo blanco." },
      { enunciado: "¿Qué dos etiquetas miden 74 × 105 mm?", opciones: [{ texto: "CAO y material magnetizado" }, { texto: "Baterías de litio y calor" }, { texto: "Posición del bulto y líquidos criogénicos" }], correcta: 2, explicacion: "Las dos comparten dimensión." },
  ...
  },
  {
    ...
    rondas: [
      { enunciado: "«4GV/X17.3/S/18» junto al símbolo de la ONU.", opciones: [{ texto: "Número ONU de la mercancía" }, { texto: "Número de guía aérea" }, { texto: "Marca de especificación del embalaje" }], correcta: 2, explicacion: "Identifica un embalaje certificado según una especificación de diseño: tipo, grupo de embalaje que admite, estado de la materia y masa máxima. Su diseño pasó los ensayos de caída, apilamiento y presión interna." },
      ...
      { enunciado: "Un rombo con una «Y» en el centro.", opciones: [{ texto: "Cantidad exceptuada" }, { texto: "Grupo de embalaje" }, { texto: "Cantidad limitada por vía aérea" }], correcta: 2, explicacion: "La marca Y señala el régimen de cantidad limitada. No autoriza por sí sola el envío: la entrada debe permitir una instrucción «Y» y el bulto cumplir sus límites." },
      { enunciado: "Una entrada con código E0.", opciones: [{ texto: "No admite el régimen de cantidad exceptuada" }, { texto: "Admite cantidad exceptuada" }, { texto: "Es una marca de manipulación" }], correcta: 0, explicacion: "E0 significa que no se admite ese régimen. Los códigos E1 a E5 fijan límites por envase interior y bulto exterior." },
    ],
  },
  {
    id: "principal",
    ...
    rondas: [
      ...
      { enunciado: "¿Qué pregunta responde una etiqueta de manipulación?", opciones: [{ texto: "Qué es" }, { texto: "Cuánto pesa" }, { texto: "Cómo se trata" }], correcta: 2, explicacion: "Posición, temperatura, tipo de aeronave: cuidados, no riesgos." },
    ],
  },
  {
    id: "no-vuela",
    ...
    rondas: [
      ...
      { enunciado: "Nadie sabe cuál era la etiqueta que se cayó. ¿Qué pasa?", opciones: [{ texto: "No se transporta la mercancía" }, { texto: "Se repone la más parecida" }, { texto: "Se anota en el NOTOC y sale" }], correcta: 0, explicacion: "Es una de las pocas veces que la norma dice «no se transportará» sin condiciones: si no se tiene la certeza de cuál etiqueta corresponde, el bulto se queda." },
