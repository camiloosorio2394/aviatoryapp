...
export const LECCION_14: DocScreen = {
  ...
  blocks: [
    ...
    { kind: "figura", src: "/modulos/mercancias/img-31-entrenamiento-tripulacion.webp", alt: "Clase de mercancías peligrosas para tripulaciones, con instructora, pilotos y una hoja tabulada.", ancho: 1536, alto: 1024, pie: "La formación del piloto se centra en la información que recibe y las decisiones propias de su función. El contenido y la periodicidad se verifican en el programa aprobado y la norma vigente." },
