/**
 * Progreso del módulo Gestión del combustible: el progreso de módulo común
 * (progresoModulo) con el respaldo local del tema, su RPC
 * combustible_mark_progress y la mejor nota de la evaluación.
 *
...
export interface CombustibleProgreso {
  ...
  /** Claves de práctica hechas: "c13-q1", "esc-04"… */
  practiceDone: string[]
...
/** Marca un capítulo leído, una pregunta respondida o un escenario abierto, local y en la base. */
