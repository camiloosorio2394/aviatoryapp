// GENERADO por scripts/modulos/convertir-unidades.mjs rac desde
// docs/contenido/rac.md. No se edita a mano: se edita el documento y se vuelve a
// correr el script.

/**
 * RAC: las 19 unidades, en el formato del lector de lecciones.
 *
...
/** Los 5 bloques del documento, con la unidad en la que empieza cada uno. */
...
export const RAC_LECCIONES: DocScreen[] = [
  {
    "n": 1,
    "title": "Personal aeronáutico (licencias de piloto vigentes hasta el 31/08/2027)",
    "kicker": "RAC 2",
    "minutes": 13,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Según el RAC 2, que rige hoy las licencias de piloto, ¿cuántas horas de vuelo debe acreditar como mínimo el aspirante a la licencia de piloto comercial avión (PCA)?",
            "ref": "RAC 2, 2.2.5.3",
            "clave": "u01-q1",
            "opciones": [
              {
                "t": "150 horas de vuelo",
                "fb": "El 2.2.5.3 exige como mínimo 200 horas de vuelo repartidas en presolo, maniobras, instrumentos y crucero, más 30 horas en dispositivo de instrucción. Las 150 horas son del RAC 61, que aplica desde el 31/08/2027."
              },
              {
                "t": "200 horas de vuelo",
                "ok": true,
                "fb": "El 2.2.5.3 exige como mínimo 200 horas de vuelo repartidas en presolo, maniobras, instrumentos y crucero, más 30 horas en dispositivo de instrucción. Las 150 horas son del RAC 61, que aplica desde el 31/08/2027."
              },
              {
                "t": "250 horas de vuelo",
                "fb": "El 2.2.5.3 exige como mínimo 200 horas de vuelo repartidas en presolo, maniobras, instrumentos y crucero, más 30 horas en dispositivo de instrucción. Las 150 horas son del RAC 61, que aplica desde el 31/08/2027."
              },
              {
                "t": "1.500 horas de vuelo",
                "fb": "El 2.2.5.3 exige como mínimo 200 horas de vuelo repartidas en presolo, maniobras, instrumentos y crucero, más 30 horas en dispositivo de instrucción. Las 150 horas son del RAC 61, que aplica desde el 31/08/2027."
              }
            ]
          },
          {
            "q": "Según el RAC 2, ¿con qué periodicidad deben hacer repaso, entrenamiento y chequeo de proeficiencia los PTL y los pilotos y copilotos PCA?",
            "ref": "RAC 2, 2.2.1.1.4 (b)",
            "clave": "u01-q2",
            "opciones": [
              {
                "t": "Una vez cada 12 meses calendario, en el mes de su cumpleaños",
                "fb": "El 2.2.1.1.4(b) pide dos repasos con entrenamiento de vuelo y verificación de la competencia en cada periodo de 12 meses calendario, con intervalos no inferiores a 5 ni mayores a 7 meses. Los 24 meses corresponden al repaso del piloto privado (2.2.3.10)."
              },
              {
                "t": "Dos veces cada 12 meses calendario, con intervalos de 3 a 9 meses",
                "fb": "El 2.2.1.1.4(b) pide dos repasos con entrenamiento de vuelo y verificación de la competencia en cada periodo de 12 meses calendario, con intervalos no inferiores a 5 ni mayores a 7 meses. Los 24 meses corresponden al repaso del piloto privado (2.2.3.10)."
              },
              {
                "t": "Una vez cada 24 meses calendario, con un repaso de tierra anual",
                "fb": "El 2.2.1.1.4(b) pide dos repasos con entrenamiento de vuelo y verificación de la competencia en cada periodo de 12 meses calendario, con intervalos no inferiores a 5 ni mayores a 7 meses. Los 24 meses corresponden al repaso del piloto privado (2.2.3.10)."
              },
              {
                "t": "Dos veces cada 12 meses calendario, con intervalos de 5 a 7 meses",
                "ok": true,
                "fb": "El 2.2.1.1.4(b) pide dos repasos con entrenamiento de vuelo y verificación de la competencia en cada periodo de 12 meses calendario, con intervalos no inferiores a 5 ni mayores a 7 meses. Los 24 meses corresponden al repaso del piloto privado (2.2.3.10)."
              }
            ]
          ...
          {
            "q": "Reprobaste por primera vez el examen teórico final de tu licencia. Según el RAC 2, ¿cuándo puedes presentarlo de nuevo y con qué nota mínima?",
            "ref": "RAC 2, 2.1.3.1.4 (e) y (f)",
            "clave": "u01-q3",
            "opciones": [
              {
                "t": "Pasados 7 días calendario, con nota mínima de 70 %",
                "ok": true,
                "fb": "Tras la primera reprobación esperas 7 días calendario; si fallas otra vez, 15 días con curso de repaso, y la cuarta y última prueba va a los 30 días. La nota mínima es 70 %; el 75 % y los 30 días de espera son del RAC 61."
              },
              {
                "t": "Pasados 30 días calendario, con nota mínima de 75 %",
                "fb": "Tras la primera reprobación esperas 7 días calendario; si fallas otra vez, 15 días con curso de repaso, y la cuarta y última prueba va a los 30 días. La nota mínima es 70 %; el 75 % y los 30 días de espera son del RAC 61."
              },
              {
                "t": "Al día siguiente, si un centro de instrucción certifica repaso",
                "fb": "Tras la primera reprobación esperas 7 días calendario; si fallas otra vez, 15 días con curso de repaso, y la cuarta y última prueba va a los 30 días. La nota mínima es 70 %; el 75 % y los 30 días de espera son del RAC 61."
              },
              {
                "t": "Pasados 6 meses, el mismo plazo que se aplica al fraude",
                "fb": "Tras la primera reprobación esperas 7 días calendario; si fallas otra vez, 15 días con curso de repaso, y la cuarta y última prueba va a los 30 días. La nota mínima es 70 %; el 75 % y los 30 días de espera son del RAC 61."
              }
            ]
          },
          {
            "q": "Has volado 300 horas como copiloto en un avión certificado para un solo piloto. Según el RAC 2, ¿cuántas te acreditan para una licencia de piloto de grado superior?",
            "ref": "RAC 2, 2.2.1.4.2",
            "clave": "u01-q4",
            "opciones": [
              {
                "t": "300 horas, porque el tiempo de copiloto siempre cuenta completo",
                "fb": "En un avión certificado para un solo piloto se acredita el 50 % del tiempo como copiloto (una hora por cada dos). Si el avión está certificado para volar con copiloto, ese tiempo cuenta completo (2.2.1.4.3)."
              },
              {
                "t": "100 horas, es decir, un tercio del tiempo volado como copiloto",
                "fb": "En un avión certificado para un solo piloto se acredita el 50 % del tiempo como copiloto (una hora por cada dos). Si el avión está certificado para volar con copiloto, ese tiempo cuenta completo (2.2.1.4.3)."
              },
              {
                "t": "150 horas, es decir, el 50 % del tiempo volado como copiloto",
                "ok": true,
                "fb": "En un avión certificado para un solo piloto se acredita el 50 % del tiempo como copiloto (una hora por cada dos). Si el avión está certificado para volar con copiloto, ese tiempo cuenta completo (2.2.1.4.3)."
              },
              {
                "t": "Ninguna, porque solo cuenta el tiempo como piloto al mando",
                "fb": "En un avión certificado para un solo piloto se acredita el 50 % del tiempo como copiloto (una hora por cada dos). Si el avión está certificado para volar con copiloto, ese tiempo cuenta completo (2.2.1.4.3)."
              }
            ]
          }
  ...
  },
  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "El RAC 61 reemplazará al RAC 2 como norma de licencias de piloto. ¿Desde qué fecha se expiden y tramitan las licencias y habilitaciones de piloto conforme al RAC 61?",
            "ref": "RAC 61, Normas de transición (a) y (b), en el texto de la Res. 02543 de 2026",
            "clave": "u02-q1",
            "opciones": [
              {
                "t": "Desde el 31 de julio de 2026",
                "fb": "La ampliación de 2026 fijó el 31/08/2027: desde esa fecha las licencias y habilitaciones de piloto se tramitan por el RAC 61, y hasta entonces rige el RAC 2, Capítulos I y II. El 31/12/2026 es solo el plazo para publicar las instrucciones de implementación (literal q)."
              },
              {
                "t": "Desde el 31 de diciembre de 2026",
                "fb": "La ampliación de 2026 fijó el 31/08/2027: desde esa fecha las licencias y habilitaciones de piloto se tramitan por el RAC 61, y hasta entonces rige el RAC 2, Capítulos I y II. El 31/12/2026 es solo el plazo para publicar las instrucciones de implementación (literal q)."
              },
              {
                "t": "Desde el 31 de agosto de 2027",
                "ok": true,
                "fb": "La ampliación de 2026 fijó el 31/08/2027: desde esa fecha las licencias y habilitaciones de piloto se tramitan por el RAC 61, y hasta entonces rige el RAC 2, Capítulos I y II. El 31/12/2026 es solo el plazo para publicar las instrucciones de implementación (literal q)."
              },
              {
                "t": "Desde el 31 de julio de 2027",
                "fb": "La ampliación de 2026 fijó el 31/08/2027: desde esa fecha las licencias y habilitaciones de piloto se tramitan por el RAC 61, y hasta entonces rige el RAC 2, Capítulos I y II. El 31/12/2026 es solo el plazo para publicar las instrucciones de implementación (literal q)."
              }
            ]
          },
          {
            "q": "Según el RAC 61, que aplica desde el 31/08/2027, ¿qué puede hacer en transporte aéreo comercial el titular de una licencia de piloto comercial (PCA)?",
            "ref": "RAC 61, 61.630 (a)(3) y (a)(4)",
            "clave": "u02-q2",
            "opciones": [
              {
                "t": "Ser PIC solo en aeronaves certificadas para un piloto, y copiloto donde se requiera",
                "ok": true,
                "fb": "El PCA puede ser PIC en transporte aéreo comercial solo en aeronaves certificadas para un piloto, y copiloto en las que lo requieran. Ser PIC en transporte comercial en aeronaves de más de un piloto es atribución del PTL (61.830(a)(2))."
              },
              {
                "t": "Ser PIC en cualquier aeronave con habilitación de tipo vigente, y también copiloto",
                "fb": "El PCA puede ser PIC en transporte aéreo comercial solo en aeronaves certificadas para un piloto, y copiloto en las que lo requieran. Ser PIC en transporte comercial en aeronaves de más de un piloto es atribución del PTL (61.830(a)(2))."
              },
              {
                "t": "Ser solo copiloto, porque para ser PIC en transporte comercial necesita licencia PTL",
                "fb": "El PCA puede ser PIC en transporte aéreo comercial solo en aeronaves certificadas para un piloto, y copiloto en las que lo requieran. Ser PIC en transporte comercial en aeronaves de más de un piloto es atribución del PTL (61.830(a)(2))."
              },
              {
                "t": "Ser PIC en aeronaves de más de un piloto, siempre que acredite 1.500 horas de vuelo",
                "fb": "El PCA puede ser PIC en transporte aéreo comercial solo en aeronaves certificadas para un piloto, y copiloto en las que lo requieran. Ser PIC en transporte comercial en aeronaves de más de un piloto es atribución del PTL (61.830(a)(2))."
              }
            ]
          },
          {
            "q": "Según el RAC 61, que aplica desde el 31/08/2027: vas a actuar como PIC en un vuelo IFR y no tienes una verificación de competencia reciente. ¿Qué experiencia por instrumentos necesitas?",
            "ref": "RAC 61, 61.140 (c)(1)",
            "clave": "u02-q3",
            "opciones": [
              {
                "t": "3 horas de instrumentos y 3 aproximaciones en los últimos 90 días",
                "fb": "Para ser PIC en IFR necesitas, en los últimos 6 meses, 6 horas de vuelo por instrumentos (3 en la categoría de la aeronave) con al menos 6 aproximaciones, o una verificación de competencia en esa categoría. Los 90 días son de la recencia de despegues y aterrizajes (61.140(a))."
              },
              {
                "t": "6 aproximaciones en los últimos 90 días, sin un mínimo de horas",
                "fb": "Para ser PIC en IFR necesitas, en los últimos 6 meses, 6 horas de vuelo por instrumentos (3 en la categoría de la aeronave) con al menos 6 aproximaciones, o una verificación de competencia en esa categoría. Los 90 días son de la recencia de despegues y aterrizajes (61.140(a))."
              },
              {
                "t": "12 horas de instrumentos y 12 aproximaciones en los últimos 12 meses",
                "fb": "Para ser PIC en IFR necesitas, en los últimos 6 meses, 6 horas de vuelo por instrumentos (3 en la categoría de la aeronave) con al menos 6 aproximaciones, o una verificación de competencia en esa categoría. Los 90 días son de la recencia de despegues y aterrizajes (61.140(a))."
              },
              {
                "t": "6 horas en 6 meses, 3 en la categoría, con al menos 6 aproximaciones",
                "ok": true,
                "fb": "Para ser PIC en IFR necesitas, en los últimos 6 meses, 6 horas de vuelo por instrumentos (3 en la categoría de la aeronave) con al menos 6 aproximaciones, o una verificación de competencia en esa categoría. Los 90 días son de la recencia de despegues y aterrizajes (61.140(a))."
              }
            ]
  ...
  {
    "n": 3,
    "title": "Normas para el otorgamiento del certificado médico aeronáutico",
    "kicker": "RAC 67",
    "minutes": 9,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Según el RAC 67, ¿cuánto dura el certificado médico Clase 1 de un titular de licencia PCA o PTL?",
            "ref": "RAC 67, 67.025 (a)(1) y (b)",
            "clave": "u03-q1",
            "opciones": [
              {
                "t": "6 meses a cualquier edad, por ser una licencia profesional",
                "fb": "La Clase 1 vale 12 meses, y cuando el titular de licencia PCA o PTL cumple 40 años se reduce a 6 meses. La vigencia se calcula con la edad que tienes el día del examen (67.025(g))."
              },
              {
                "t": "12 meses, y 6 meses desde que el titular cumple 40 años",
                "ok": true,
                "fb": "La Clase 1 vale 12 meses, y cuando el titular de licencia PCA o PTL cumple 40 años se reduce a 6 meses. La vigencia se calcula con la edad que tienes el día del examen (67.025(g))."
              },
              {
                "t": "12 meses, y 3 meses desde que el titular cumple 40 años",
                "fb": "La Clase 1 vale 12 meses, y cuando el titular de licencia PCA o PTL cumple 40 años se reduce a 6 meses. La vigencia se calcula con la edad que tienes el día del examen (67.025(g))."
              },
              {
                "t": "24 meses, y 12 meses desde que el titular cumple 40 años",
                "fb": "La Clase 1 vale 12 meses, y cuando el titular de licencia PCA o PTL cumple 40 años se reduce a 6 meses. La vigencia se calcula con la edad que tienes el día del examen (67.025(g))."
              }
            ]
          },
          {
            "q": "Cumples la agudeza visual de Clase 1 solo con lentes de contacto. Según el RAC 67, ¿qué condición deben cumplir esos lentes?",
            "ref": "RAC 67, 67.210 (e) y (f)",
            "clave": "u03-q2",
            "opciones": [
              {
                "t": "Pueden ser multifocales o de color si te corrigen a 20/20",
                "fb": "El 67.210(e) acepta lentes de contacto monofocales, sin color, bien tolerados y con un par de repuesto a mano. No se permite lente de contacto y gafas a la vez en el mismo ojo (67.210(f)), y las gafas de sol deben ser no polarizadas (67.090(b)(9))."
              },
              {
                "t": "Puedes combinarlos con gafas en el mismo ojo si lo necesitas",
                "fb": "El 67.210(e) acepta lentes de contacto monofocales, sin color, bien tolerados y con un par de repuesto a mano. No se permite lente de contacto y gafas a la vez en el mismo ojo (67.210(f)), y las gafas de sol deben ser no polarizadas (67.090(b)(9))."
              },
              {
                "t": "Deben ser monofocales y sin color, con un par de repuesto a mano",
                "ok": true,
                "fb": "El 67.210(e) acepta lentes de contacto monofocales, sin color, bien tolerados y con un par de repuesto a mano. No se permite lente de contacto y gafas a la vez en el mismo ojo (67.210(f)), y las gafas de sol deben ser no polarizadas (67.090(b)(9))."
              },
              {
                "t": "Solo se aceptan si en vuelo usas gafas de sol polarizadas",
                "fb": "El 67.210(e) acepta lentes de contacto monofocales, sin color, bien tolerados y con un par de repuesto a mano. No se permite lente de contacto y gafas a la vez en el mismo ojo (67.210(f)), y las gafas de sol deben ser no polarizadas (67.090(b)(9))."
              }
            ]
          },
          {
            "q": "Una lesión te deja con reposo médico de 25 días, sin hospitalización ni medicamentos continuos. Según el RAC 67, ¿debes informarlo a Medicina Aeronáutica de la Aerocivil?",
            "ref": "RAC 67, 67.040 (d)",
            "clave": "u03-q3",
            "opciones": [
              {
                "t": "Sí: se informa toda disminución de aptitud de más de 20 días",
                "ok": true,
                "fb": "Debes informar toda disminución de aptitud de más de 20 días, la que exija tratamiento continuo con medicamentos recetados o la que haya requerido hospitalización: basta una de las tres. Además, dejas de ejercer apenas sepas que tu aptitud disminuyó (67.040(a))."
              },
              {
                "t": "No: solo se informa cuando hubo hospitalización",
                "fb": "Debes informar toda disminución de aptitud de más de 20 días, la que exija tratamiento continuo con medicamentos recetados o la que haya requerido hospitalización: basta una de las tres. Además, dejas de ejercer apenas sepas que tu aptitud disminuyó (67.040(a))."
              },
              {
                "t": "No: solo se informa si la incapacidad médica supera los 45 días",
                "fb": "Debes informar toda disminución de aptitud de más de 20 días, la que exija tratamiento continuo con medicamentos recetados o la que haya requerido hospitalización: basta una de las tres. Además, dejas de ejercer apenas sepas que tu aptitud disminuyó (67.040(a))."
              },
              {
                "t": "Solo si tu certificado médico vence durante la incapacidad",
                "fb": "Debes informar toda disminución de aptitud de más de 20 días, la que exija tratamiento continuo con medicamentos recetados o la que haya requerido hospitalización: basta una de las tres. Además, dejas de ejercer apenas sepas que tu aptitud disminuyó (67.040(a))."
              }
            ]
          }
  ...
  {
    "n": 4,
    "title": "Prevención y control del consumo indebido de sustancias psicoactivas en el personal aeronáutico",
    "kicker": "RAC 120",
    "minutes": 8,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Tienes vuelo a las 06:00 y anoche tomaste vino en una cena. Según el RAC 120, ¿cuántas horas mínimas deben pasar entre la última bebida y el inicio de tus funciones?",
            "ref": "RAC 120, 120.025 (a) y 120.001 (Nivel de aceptación; Resultado positivo, Nota)",
            "clave": "u04-q1",
            "opciones": [
              {
                "t": "8 horas desde la última bebida, sin importar la cantidad",
                "fb": "El RAC 120 no fija horas entre la última bebida y el servicio: prohíbe estar bajo el efecto de cualquier sustancia psicoactiva en funciones, y el nivel aceptado es un resultado negativo (corte de alcohol: 20 mg/dL). Si tu aerolínea fija un plazo en su manual, también lo cumples."
              },
              {
                "t": "12 horas desde la última bebida, sin importar la cantidad",
                "fb": "El RAC 120 no fija horas entre la última bebida y el servicio: prohíbe estar bajo el efecto de cualquier sustancia psicoactiva en funciones, y el nivel aceptado es un resultado negativo (corte de alcohol: 20 mg/dL). Si tu aerolínea fija un plazo en su manual, también lo cumples."
              },
              {
                "t": "24 horas si tomaste más de dos copas, y 12 horas si fueron menos",
                "fb": "El RAC 120 no fija horas entre la última bebida y el servicio: prohíbe estar bajo el efecto de cualquier sustancia psicoactiva en funciones, y el nivel aceptado es un resultado negativo (corte de alcohol: 20 mg/dL). Si tu aerolínea fija un plazo en su manual, también lo cumples."
              },
              {
                "t": "No fija horas: debes dar negativo y no estar bajo su efecto",
                "ok": true,
                "fb": "El RAC 120 no fija horas entre la última bebida y el servicio: prohíbe estar bajo el efecto de cualquier sustancia psicoactiva en funciones, y el nivel aceptado es un resultado negativo (corte de alcohol: 20 mg/dL). Si tu aerolínea fija un plazo en su manual, también lo cumples."
              }
            ]
          ...
          {
            "q": "Según el RAC 120, ¿qué sustancias deben buscarse como mínimo en los exámenes toxicológicos del personal aeronáutico?",
            "ref": "RAC 120, 120.310 (a)",
            "clave": "u04-q2",
            "opciones": [
              {
                "t": "Alcohol, opioides, cannabinoides, cocaína, anfetaminas y cafeína",
                "fb": "El 120.310(a) fija como mínimo alcohol, opioides, cannabinoides, cocaína, anfetaminas y benzodiacepinas, y la empresa puede buscar más. El tabaco y la cafeína están excluidos de la definición de sustancias psicoactivas (120.001)."
              },
              {
                "t": "Alcohol, opioides, cannabinoides, cocaína, anfetaminas y benzodiacepinas",
                "ok": true,
                "fb": "El 120.310(a) fija como mínimo alcohol, opioides, cannabinoides, cocaína, anfetaminas y benzodiacepinas, y la empresa puede buscar más. El tabaco y la cafeína están excluidos de la definición de sustancias psicoactivas (120.001)."
              },
              {
                "t": "Alcohol, cannabinoides, cocaína, tabaco, anfetaminas, opioides y cafeína",
                "fb": "El 120.310(a) fija como mínimo alcohol, opioides, cannabinoides, cocaína, anfetaminas y benzodiacepinas, y la empresa puede buscar más. El tabaco y la cafeína están excluidos de la definición de sustancias psicoactivas (120.001)."
              },
              {
                "t": "Solo alcohol y cannabinoides; lo demás queda a criterio de la empresa",
                "fb": "El 120.310(a) fija como mínimo alcohol, opioides, cannabinoides, cocaína, anfetaminas y benzodiacepinas, y la empresa puede buscar más. El tabaco y la cafeína están excluidos de la definición de sustancias psicoactivas (120.001)."
              }
            ]
          },
          {
            "q": "Según el RAC 120, si entre tu examen toxicológico previo negativo y el inicio de tus funciones sensibles pasa más de cierto plazo, debes repetirlo. ¿Cuál es ese plazo?",
            "ref": "RAC 120, 120.320 (a)(4)",
            "clave": "u04-q3",
            "opciones": [
              {
                "t": "Más de 90 días",
                "fb": "Si pasan más de 180 días entre el examen previo y el inicio de las funciones sensibles, repites el examen y esperas resultado negativo antes de empezar. Los 24 meses son la frecuencia recomendada para examinar a cada persona (120.030(c))."
              },
              {
                "t": "Más de 12 meses",
                "fb": "Si pasan más de 180 días entre el examen previo y el inicio de las funciones sensibles, repites el examen y esperas resultado negativo antes de empezar. Los 24 meses son la frecuencia recomendada para examinar a cada persona (120.030(c))."
  ...
  {
    "n": 5,
    "title": "Reglas Generales de Vuelo y de Operación",
    "kicker": "RAC 91",
    "minutes": 11,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Vuelas VFR a 7.500 ft MSL en espacio aéreo clase E, sobre un terreno de 2.000 ft. Según el Apéndice 1 del RAC 91, ¿qué visibilidad y distancia de las nubes necesitas como mínimo?",
            "ref": "RAC 91, Apéndice 1, Tabla 1-1",
            "clave": "u05-q1",
            "opciones": [
              {
                "t": "8 km; 1.500 m horizontal y 1.000 ft vertical de las nubes",
                "fb": "Por debajo de 10.000 ft MSL y por encima de 3.000 ft MSL o de 1.000 ft sobre el terreno (el mayor), se exigen 5 km de visibilidad y 1.500 m horizontal y 1.000 ft vertical de las nubes. Los 8 km son para 10.000 ft o más, y «libre de nubes y con la superficie a la vista» es solo para F y G en la banda baja."
              },
              {
                "t": "5 km; libre de nubes y con la superficie a la vista",
                "fb": "Por debajo de 10.000 ft MSL y por encima de 3.000 ft MSL o de 1.000 ft sobre el terreno (el mayor), se exigen 5 km de visibilidad y 1.500 m horizontal y 1.000 ft vertical de las nubes. Los 8 km son para 10.000 ft o más, y «libre de nubes y con la superficie a la vista» es solo para F y G en la banda baja."
              },
              {
                "t": "5 km; 1.500 m horizontal y 1.000 ft vertical de nubes",
                "ok": true,
                "fb": "Por debajo de 10.000 ft MSL y por encima de 3.000 ft MSL o de 1.000 ft sobre el terreno (el mayor), se exigen 5 km de visibilidad y 1.500 m horizontal y 1.000 ft vertical de las nubes. Los 8 km son para 10.000 ft o más, y «libre de nubes y con la superficie a la vista» es solo para F y G en la banda baja."
              },
              {
                "t": "1.500 m; libre de nubes y con la superficie a la vista",
                "fb": "Por debajo de 10.000 ft MSL y por encima de 3.000 ft MSL o de 1.000 ft sobre el terreno (el mayor), se exigen 5 km de visibilidad y 1.500 m horizontal y 1.000 ft vertical de las nubes. Los 8 km son para 10.000 ft o más, y «libre de nubes y con la superficie a la vista» es solo para F y G en la banda baja."
              }
            ]
          },
          {
            "q": "Planeas un vuelo IFR en avión bajo la Parte 1 del RAC 91. Además del combustible para llegar al destino y luego al alterno más distante, ¿qué reserva final debes llevar?",
            "ref": "RAC 91, 91.610 (a)(2)(ii)",
            "clave": "u05-q2",
            "opciones": [
              {
                "t": "30 minutos de vuelo a altitud normal de crucero",
                "fb": "Para IFR, 91.610 exige una reserva final de al menos 45 minutos a altitud normal de crucero. Los 30 minutos a altitud de crucero son del VFR diurno, y los 30 minutos en espera a 1.500 ft son de la Parte 2 para aviones de turbina (91.2012)."
              },
              {
                "t": "45 minutos de vuelo a altitud normal de crucero",
                "ok": true,
                "fb": "Para IFR, 91.610 exige una reserva final de al menos 45 minutos a altitud normal de crucero. Los 30 minutos a altitud de crucero son del VFR diurno, y los 30 minutos en espera a 1.500 ft son de la Parte 2 para aviones de turbina (91.2012)."
              },
              {
                "t": "30 minutos en espera a 1.500 ft sobre el aeródromo",
                "fb": "Para IFR, 91.610 exige una reserva final de al menos 45 minutos a altitud normal de crucero. Los 30 minutos a altitud de crucero son del VFR diurno, y los 30 minutos en espera a 1.500 ft son de la Parte 2 para aviones de turbina (91.2012)."
              },
              {
                "t": "60 minutos de vuelo a altitud normal de crucero",
                "fb": "Para IFR, 91.610 exige una reserva final de al menos 45 minutos a altitud normal de crucero. Los 30 minutos a altitud de crucero son del VFR diurno, y los 30 minutos en espera a 1.500 ft son de la Parte 2 para aviones de turbina (91.2012)."
              }
            ]
          },
          {
            "q": "Vuelas IFR en IMC, en espacio aéreo con radar, y pierdes las comunicaciones. Pones 7600. Según el RAC 91, ¿durante cuánto tiempo mantienes el último nivel y velocidad asignados antes de ajustarlos al plan de vuelo?",
            "ref": "RAC 91, 91.265 (b)(2)(ii)",
            "clave": "u05-q3",
            "opciones": [
              {
                "t": "7 minutos, desde lo último entre alcanzar el nivel, poner 7600 o no notificar",
                "ok": true,
                "fb": "Donde se usa radar, mantienes el último nivel y velocidad asignados (o la altitud mínima, si es mayor) durante 7 minutos, contados desde lo que ocurra más tarde entre alcanzar el nivel, poner 7600 o dejar de notificar un punto obligatorio. Los 20 minutos aplican donde no se usa radar."
              },
              {
                "t": "20 minutos, desde que dejaste de notificar un punto de notificación obligatoria",
                "fb": "Donde se usa radar, mantienes el último nivel y velocidad asignados (o la altitud mínima, si es mayor) durante 7 minutos, contados desde lo que ocurra más tarde entre alcanzar el nivel, poner 7600 o dejar de notificar un punto obligatorio. Los 20 minutos aplican donde no se usa radar."
              },
              {
                "t": "3 minutos, contados desde que pusiste el código 7600 en el transpondedor",
                "fb": "Donde se usa radar, mantienes el último nivel y velocidad asignados (o la altitud mínima, si es mayor) durante 7 minutos, contados desde lo que ocurra más tarde entre alcanzar el nivel, poner 7600 o dejar de notificar un punto obligatorio. Los 20 minutos aplican donde no se usa radar."
              },
              {
                "t": "30 minutos, contados desde la última hora prevista de aproximación recibida",
                "fb": "Donde se usa radar, mantienes el último nivel y velocidad asignados (o la altitud mínima, si es mayor) durante 7 minutos, contados desde lo que ocurra más tarde entre alcanzar el nivel, poner 7600 o dejar de notificar un punto obligatorio. Los 20 minutos aplican donde no se usa radar."
              }
            ]
          },
          {
            "q": "En una aproximación por instrumentos, todavía antes del tramo de aproximación final y a 2.000 ft sobre la elevación del aeródromo, te informan un RVR de control inferior al mínimo. Según el RAC 91, ¿qué aplica?",
            "ref": "RAC 91, 91.585 (b) y (c)",
            "clave": "u05-q4",
            "opciones": [
              {
                "t": "Puedes seguir hasta la DA/H, porque ya estás establecido en la aproximación",
                "fb": "Con la visibilidad o el RVR de control bajo mínimos, la aproximación no puede continuarse por debajo de 1.000 ft (300 m) sobre la elevación del aeródromo. Solo si el informe llega después de entrar al tramo final o de bajar de 1.000 ft puedes seguir hasta la DA/H o MDA/H."
              },
              {
                "t": "No puedes continuar por debajo de 500 ft sobre la elevación del aeródromo",
                "fb": "Con la visibilidad o el RVR de control bajo mínimos, la aproximación no puede continuarse por debajo de 1.000 ft (300 m) sobre la elevación del aeródromo. Solo si el informe llega después de entrar al tramo final o de bajar de 1.000 ft puedes seguir hasta la DA/H o MDA/H."
              },
              {
                "t": "Solo puedes seguir si el techo reportado está por encima de 1.000 ft",
                "fb": "Con la visibilidad o el RVR de control bajo mínimos, la aproximación no puede continuarse por debajo de 1.000 ft (300 m) sobre la elevación del aeródromo. Solo si el informe llega después de entrar al tramo final o de bajar de 1.000 ft puedes seguir hasta la DA/H o MDA/H."
              },
              {
                "t": "No puedes continuar por debajo de 1.000 ft sobre la elevación del aeródromo",
                "ok": true,
                "fb": "Con la visibilidad o el RVR de control bajo mínimos, la aproximación no puede continuarse por debajo de 1.000 ft (300 m) sobre la elevación del aeródromo. Solo si el informe llega después de entrar al tramo final o de bajar de 1.000 ft puedes seguir hasta la DA/H o MDA/H."
              }
            ]
  ...
  {
    "n": 6,
    "title": "Gestión del tránsito aéreo",
    "kicker": "RAC 211",
    "minutes": 8,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Según la tabla de clases de espacio aéreo del RAC 211, ¿en qué clases un vuelo VFR no está sujeto a autorización del control de tránsito aéreo (ATC)?",
            "ref": "RAC 211, Apéndice 1 (tabla de clases de espacio aéreo ATS)",
            "clave": "u06-q1",
            "opciones": [
              {
                "t": "Solo en la clase G",
                "fb": "En la tabla colombiana, los VFR necesitan autorización ATC en las clases B, C y D, pero no en E, F ni G. El error típico es creer que la clase E la exige a todos: solo se la exige a los IFR."
              },
              {
                "t": "En las clases E, F y G",
                "ok": true,
                "fb": "En la tabla colombiana, los VFR necesitan autorización ATC en las clases B, C y D, pero no en E, F ni G. El error típico es creer que la clase E la exige a todos: solo se la exige a los IFR."
              },
              {
                "t": "En las clases F y G",
                "fb": "En la tabla colombiana, los VFR necesitan autorización ATC en las clases B, C y D, pero no en E, F ni G. El error típico es creer que la clase E la exige a todos: solo se la exige a los IFR."
              },
              {
                "t": "En las clases D, E, F y G",
                "fb": "En la tabla colombiana, los VFR necesitan autorización ATC en las clases B, C y D, pero no en E, F ni G. El error típico es creer que la clase E la exige a todos: solo se la exige a los IFR."
              }
            ]
          },
          {
            "q": "La torre te transmite por voz varias instrucciones y datos. Según el RAC 211, ¿cuál de estos elementos debes colacionar obligatoriamente?",
            "ref": "RAC 211, 211.555 (d)(1)(iii)",
            "clave": "u06-q2",
            "opciones": [
              {
                "t": "El viento en la superficie",
                "fb": "Se colacionan siempre las autorizaciones de ruta, las de entrar, aterrizar, despegar, esperar, cruzar o regresar en una pista, y la pista en uso, el reglaje de altímetro, los códigos SSR, las instrucciones de nivel, rumbo y velocidad y los niveles de transición. Lo demás se colaciona o se acusa recibo de forma que quede claro que se entendió."
              },
              {
                "t": "La información de tránsito",
                "fb": "Se colacionan siempre las autorizaciones de ruta, las de entrar, aterrizar, despegar, esperar, cruzar o regresar en una pista, y la pista en uso, el reglaje de altímetro, los códigos SSR, las instrucciones de nivel, rumbo y velocidad y los niveles de transición. Lo demás se colaciona o se acusa recibo de forma que quede claro que se entendió."
              },
              {
                "t": "El reglaje de altímetro",
                "ok": true,
                "fb": "Se colacionan siempre las autorizaciones de ruta, las de entrar, aterrizar, despegar, esperar, cruzar o regresar en una pista, y la pista en uso, el reglaje de altímetro, los códigos SSR, las instrucciones de nivel, rumbo y velocidad y los niveles de transición. Lo demás se colaciona o se acusa recibo de forma que quede claro que se entendió."
              },
              {
                "t": "La temperatura del aeródromo",
                "fb": "Se colacionan siempre las autorizaciones de ruta, las de entrar, aterrizar, despegar, esperar, cruzar o regresar en una pista, y la pista en uso, el reglaje de altímetro, los códigos SSR, las instrucciones de nivel, rumbo y velocidad y los niveles de transición. Lo demás se colaciona o se acusa recibo de forma que quede claro que se entendió."
              }
            ]
          },
          {
            "q": "Según el RAC 211, ¿entre qué niveles de vuelo se aplica en Colombia la separación vertical mínima reducida (RVSM) de 1.000 ft?",
            "ref": "RAC 211, 211.530 (a) y (b)",
            "clave": "u06-q3",
            "opciones": [
              {
                "t": "Entre FL 290 y FL 410, inclusive",
                "ok": true,
                "fb": "El 211.530 fija la separación de 300 m (1.000 ft) entre FL 290 y FL 410 inclusive, con monitoreo de la agencia regional CARSAMMA."
              },
              {
                "t": "Entre FL 280 y FL 420, inclusive",
                "fb": "El 211.530 fija la separación de 300 m (1.000 ft) entre FL 290 y FL 410 inclusive, con monitoreo de la agencia regional CARSAMMA."
              },
              {
                "t": "Entre FL 290 y FL 450, inclusive",
                "fb": "El 211.530 fija la separación de 300 m (1.000 ft) entre FL 290 y FL 410 inclusive, con monitoreo de la agencia regional CARSAMMA."
              },
              {
                "t": "Desde FL 250 hasta FL 410, inclusive",
                "fb": "El 211.530 fija la separación de 300 m (1.000 ft) entre FL 290 y FL 410 inclusive, con monitoreo de la agencia regional CARSAMMA."
              }
            ]
          }
  ...
  {
    "n": 7,
    "title": "Servicio de búsqueda y salvamento",
    "kicker": "RAC 212",
    "minutes": 7,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "De día, sobrevuelas a unos supervivientes que hicieron una señal en tierra y la entendiste. Según el RAC 212, ¿cómo se lo indicas desde el aire?",
            "ref": "RAC 212, Apéndice 1, 3.1 (a)",
            "clave": "u07-q1",
            "opciones": [
              {
                "t": "Describiendo un círculo sobre ellos",
                "fb": "De día, «entendí tu señal» se indica alabeando las alas; de noche, con dos destellos de los faros de aterrizaje o, si no los tienes, encendiendo y apagando dos veces las luces de navegación. Describir un círculo significa mensaje recibido pero no comprendido."
              },
              {
                "t": "Cabeceando el morro varias veces",
                "fb": "De día, «entendí tu señal» se indica alabeando las alas; de noche, con dos destellos de los faros de aterrizaje o, si no los tienes, encendiendo y apagando dos veces las luces de navegación. Describir un círculo significa mensaje recibido pero no comprendido."
              },
              {
                "t": "Con dos destellos de los faros de aterrizaje",
                "fb": "De día, «entendí tu señal» se indica alabeando las alas; de noche, con dos destellos de los faros de aterrizaje o, si no los tienes, encendiendo y apagando dos veces las luces de navegación. Describir un círculo significa mensaje recibido pero no comprendido."
              },
              {
                "t": "Alabeando las alas de la aeronave",
                "ok": true,
                "fb": "De día, «entendí tu señal» se indica alabeando las alas; de noche, con dos destellos de los faros de aterrizaje o, si no los tienes, encendiendo y apagando dos veces las luces de navegación. Describir un círculo significa mensaje recibido pero no comprendido."
              }
            ]
          ...
          {
            "q": "Sobrevuelas el sitio de un accidente y ves en tierra una X grande hecha por los supervivientes. Según el RAC 212, ¿qué significa?",
            "ref": "RAC 212, Apéndice 1, 2.1",
            "clave": "u07-q2",
            "opciones": [
              {
                "t": "Necesitamos ayuda médica",
                "ok": true,
                "fb": "En el código de los supervivientes, V es «necesitamos ayuda», X es «necesitamos ayuda médica», N es «no», Y es «sí» y la flecha es «estamos avanzando en esta dirección». «No hemos encontrado nada» es NN y lo usan las brigadas de salvamento."
              },
              {
                "t": "Necesitamos ayuda",
                "fb": "En el código de los supervivientes, V es «necesitamos ayuda», X es «necesitamos ayuda médica», N es «no», Y es «sí» y la flecha es «estamos avanzando en esta dirección». «No hemos encontrado nada» es NN y lo usan las brigadas de salvamento."
              ...
              {
                "t": "Estamos avanzando en esa dirección",
                "fb": "En el código de los supervivientes, V es «necesitamos ayuda», X es «necesitamos ayuda médica», N es «no», Y es «sí» y la flecha es «estamos avanzando en esta dirección». «No hemos encontrado nada» es NN y lo usan las brigadas de salvamento."
              },
              {
                "t": "No hemos encontrado nada",
                "fb": "En el código de los supervivientes, V es «necesitamos ayuda», X es «necesitamos ayuda médica», N es «no», Y es «sí» y la flecha es «estamos avanzando en esta dirección». «No hemos encontrado nada» es NN y lo usan las brigadas de salvamento."
              }
            ]
          },
          {
            "q": "Vas en crucero escuchando 121,5 MHz y captas la señal de una baliza de socorro. Según el RAC 212, además de informar al RCC o al ATS, ¿qué debes hacer?",
            "ref": "RAC 212, 212.426 (b)",
            "clave": "u07-q3",
            "opciones": [
              {
                "t": "Bajar el silenciador (squelch) para oír mejor la señal y seguirla",
                "fb": "Debes anotar y comunicar cuanto antes la posición donde recibiste la señal por primera vez, no alterar el ajuste del silenciador y, si puedes, seguir escuchando hasta que cese. Mantener el silenciador como estaba le da al RCC la ubicación más precisa de la baliza."
              },
              {
                "t": "Anotar dónde la oíste primero y no tocar el silenciador (squelch)",
                "ok": true,
                "fb": "Debes anotar y comunicar cuanto antes la posición donde recibiste la señal por primera vez, no alterar el ajuste del silenciador y, si puedes, seguir escuchando hasta que cese. Mantener el silenciador como estaba le da al RCC la ubicación más precisa de la baliza."
              },
              {
                "t": "Cambiar a 123,1 MHz para coordinar con las demás aeronaves en la zona",
                "fb": "Debes anotar y comunicar cuanto antes la posición donde recibiste la señal por primera vez, no alterar el ajuste del silenciador y, si puedes, seguir escuchando hasta que cese. Mantener el silenciador como estaba le da al RCC la ubicación más precisa de la baliza."
              },
              {
                "t": "Activar tu propio ELT para que el satélite ubique mejor el área",
                "fb": "Debes anotar y comunicar cuanto antes la posición donde recibiste la señal por primera vez, no alterar el ajuste del silenciador y, si puedes, seguir escuchando hasta que cese. Mantener el silenciador como estaba le da al RCC la ubicación más precisa de la baliza."
              }
            ]
          }
    ...
    "blocks": [
      ...
      },
      {
        ...
        "items": [
          ...
          "**Especiales**: **todas las aeronaves** las hacen cuando encuentran u observan (203.320): 1. Turbulencia **moderada o fuerte**. 2. Engelamiento **moderado o fuerte**. 3. Onda orográfica **fuerte**. 4. Tormentas sin granizo, oscurecidas, inmersas, generalizadas o en líneas de turbonada. 5. Tormentas con granizo, en las mismas condiciones. 6. Tempestades de polvo o arena fuertes. 7. Nube de cenizas volcánicas. 8. Actividad volcánica precursora de erupción o erupción. 9. **Eficacia de frenado en la pista peor que la notificada.**",
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "En vuelo encuentras varias condiciones. Según el RAC 203, ¿cuál de ellas obliga a todas las aeronaves a hacer una observación especial (AIREP especial)?",
            "ref": "RAC 203, 203.320 (a)(1)",
            "clave": "u08-q1",
            "opciones": [
              {
                "t": "Turbulencia ligera en aire claro",
                "fb": "Obligan a una observación especial la turbulencia y el engelamiento moderados o fuertes, la onda orográfica fuerte, ciertas tormentas, las tempestades fuertes de polvo o arena, las cenizas y la actividad volcánica, y el frenado peor que el notificado. Lo ligero y la onda orográfica moderada no están en la lista."
              },
              {
                "t": "Engelamiento ligero en nubes",
                "fb": "Obligan a una observación especial la turbulencia y el engelamiento moderados o fuertes, la onda orográfica fuerte, ciertas tormentas, las tempestades fuertes de polvo o arena, las cenizas y la actividad volcánica, y el frenado peor que el notificado. Lo ligero y la onda orográfica moderada no están en la lista."
              },
              {
                "t": "Turbulencia moderada o fuerte",
                "ok": true,
                "fb": "Obligan a una observación especial la turbulencia y el engelamiento moderados o fuertes, la onda orográfica fuerte, ciertas tormentas, las tempestades fuertes de polvo o arena, las cenizas y la actividad volcánica, y el frenado peor que el notificado. Lo ligero y la onda orográfica moderada no están en la lista."
              },
              {
                "t": "Onda orográfica moderada",
                "fb": "Obligan a una observación especial la turbulencia y el engelamiento moderados o fuertes, la onda orográfica fuerte, ciertas tormentas, las tempestades fuertes de polvo o arena, las cenizas y la actividad volcánica, y el frenado peor que el notificado. Lo ligero y la onda orográfica moderada no están en la lista."
              }
            ]
          },
          {
            "q": "En el despacho te entregan un SIGMET por cenizas volcánicas que afecta tu ruta. Según el RAC 203, ¿cuál es el período máximo de validez de ese tipo de SIGMET?",
            "ref": "RAC 203, 203.515 (c)",
            "clave": "u08-q2",
            "opciones": [
              {
                "t": "4 horas, igual que cualquier otro SIGMET",
                "fb": "La validez de un SIGMET no pasa de 4 horas, pero en el caso especial de las cenizas volcánicas y los ciclones tropicales se extiende a 6 horas. Por eso las 4 horas son la regla general, no la de este aviso."
              },
              {
                "t": "2 horas, igual que un pronóstico de tendencia",
                "fb": "La validez de un SIGMET no pasa de 4 horas, pero en el caso especial de las cenizas volcánicas y los ciclones tropicales se extiende a 6 horas. Por eso las 4 horas son la regla general, no la de este aviso."
              },
              {
                "t": "12 horas, contadas desde que se emite",
                "fb": "La validez de un SIGMET no pasa de 4 horas, pero en el caso especial de las cenizas volcánicas y los ciclones tropicales se extiende a 6 horas. Por eso las 4 horas son la regla general, no la de este aviso."
              },
              {
                "t": "6 horas, por ser de cenizas volcánicas",
                "ok": true,
                "fb": "La validez de un SIGMET no pasa de 4 horas, pero en el caso especial de las cenizas volcánicas y los ciclones tropicales se extiende a 6 horas. Por eso las 4 horas son la regla general, no la de este aviso."
              }
            ]
  ...
  {
    "n": 9,
    "title": "Certificación de explotadores de servicios aéreos",
    "kicker": "RAC 119",
    "minutes": 4,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Según el RAC 119, ¿qué debe llevar el explotador a bordo de sus aeronaves, con traducción al inglés cuando hace operaciones internacionales?",
            "ref": "RAC 119, 119.260 (a)(6)",
            "clave": "u09-q1",
            "opciones": [
              {
                "t": "Una copia de sus especificaciones de operación",
                "ok": true,
                "fb": "El 119.260 obliga al explotador a llevar a bordo una copia de las OpSpecs, traducida al inglés en operaciones internacionales, y a mantener informados a sus empleados de lo que aplica a sus funciones. Las OpSpecs dicen qué, dónde y con qué aprobaciones puede volar cada avión."
              },
              {
                "t": "El original del certificado de operación (CDO)",
                "fb": "El 119.260 obliga al explotador a llevar a bordo una copia de las OpSpecs, traducida al inglés en operaciones internacionales, y a mantener informados a sus empleados de lo que aplica a sus funciones. Las OpSpecs dicen qué, dónde y con qué aprobaciones puede volar cada avión."
              },
              {
                "t": "El manual de operaciones completo de la empresa",
                "fb": "El 119.260 obliga al explotador a llevar a bordo una copia de las OpSpecs, traducida al inglés en operaciones internacionales, y a mantener informados a sus empleados de lo que aplica a sus funciones. Las OpSpecs dicen qué, dónde y con qué aprobaciones puede volar cada avión."
              },
              {
                "t": "La lista de su personal directivo y sus suplentes",
                "fb": "El 119.260 obliga al explotador a llevar a bordo una copia de las OpSpecs, traducida al inglés en operaciones internacionales, y a mantener informados a sus empleados de lo que aplica a sus funciones. Las OpSpecs dicen qué, dónde y con qué aprobaciones puede volar cada avión."
              }
            ]
          },
          {
            "q": "Una empresa quiere hacer vuelos regulares de pasajeros con un turborreactor de 12 asientos y 5.600 kg de peso máximo de despegue. Según el RAC 119, ¿bajo qué reglamento debe operar?",
            "ref": "RAC 119, 119.110 (a)(1)(i)",
            "clave": "u09-q2",
            "opciones": [
              {
                "t": "RAC 135, porque tiene 19 asientos o menos",
                "fb": "En operaciones regulares, todo turborreactor va por el RAC 121, sin importar asientos ni peso. Los límites de 19 asientos y 5.700 kg deciden en los turbohélices y recíprocos regulares y en las operaciones no regulares."
              },
              {
                "t": "RAC 135, porque no supera los 5.700 kg de peso",
                "fb": "En operaciones regulares, todo turborreactor va por el RAC 121, sin importar asientos ni peso. Los límites de 19 asientos y 5.700 kg deciden en los turbohélices y recíprocos regulares y en las operaciones no regulares."
              },
              {
                "t": "RAC 121, porque es un turborreactor regular",
                "ok": true,
                "fb": "En operaciones regulares, todo turborreactor va por el RAC 121, sin importar asientos ni peso. Los límites de 19 asientos y 5.700 kg deciden en los turbohélices y recíprocos regulares y en las operaciones no regulares."
              },
              {
                "t": "RAC 91, porque es un avión pequeño",
                "fb": "En operaciones regulares, todo turborreactor va por el RAC 121, sin importar asientos ni peso. Los límites de 19 asientos y 5.700 kg deciden en los turbohélices y recíprocos regulares y en las operaciones no regulares."
              }
            ]
          }
  ...
  {
    "n": 10,
    "title": "Requisitos de operación: operaciones domésticas e internacionales, regulares y no regulares",
    "kicker": "RAC 121",
    "minutes": 12,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Según el RAC 121, ¿hasta qué edad puede una persona actuar como piloto al mando (PIC) o como copiloto?",
            "ref": "RAC 121, 121.1410 (c) y (d)",
            "clave": "u10-q1",
            "opciones": [
              {
                "t": "Hasta cumplir 60 años",
                "fb": "Nadie puede actuar como PIC o copiloto según el RAC 121 cuando haya cumplido 65 años, y en una tripulación de más de un piloto solo uno puede tener más de 60. Los 60 años son el límite de ese segundo requisito, no la edad máxima."
              },
              {
                "t": "Hasta cumplir 65 años",
                "ok": true,
                "fb": "Nadie puede actuar como PIC o copiloto según el RAC 121 cuando haya cumplido 65 años, y en una tripulación de más de un piloto solo uno puede tener más de 60. Los 60 años son el límite de ese segundo requisito, no la edad máxima."
              },
              {
                "t": "Hasta cumplir 67 años",
                "fb": "Nadie puede actuar como PIC o copiloto según el RAC 121 cuando haya cumplido 65 años, y en una tripulación de más de un piloto solo uno puede tener más de 60. Los 60 años son el límite de ese segundo requisito, no la edad máxima."
              },
              {
                "t": "Sin límite, si mantiene su médico Clase I",
                "fb": "Nadie puede actuar como PIC o copiloto según el RAC 121 cuando haya cumplido 65 años, y en una tripulación de más de un piloto solo uno puede tener más de 60. Los 60 años son el límite de ese segundo requisito, no la edad máxima."
              }
            ]
          },
          {
            "q": "Eres copiloto con 60 horas en el tipo y vuelas con un PIC que no es instructor ni chequeador. En la pista de aterrizaje el viento cruzado es de 18 kt. Según el RAC 121, ¿quién aterriza?",
            "ref": "RAC 121, 121.1735 (a)(2)(v)",
            "clave": "u10-q2",
            "opciones": [
              {
                "t": "Tú, si el PIC lo autoriza, porque el límite es de 20 kt",
                "fb": "Si el copiloto tiene menos de 100 horas en el tipo y el PIC no es instructor ni chequeador, el PIC hace todos los despegues y aterrizajes con viento cruzado de más de 15 nudos. También con visibilidad o RVR de 1.200 m o menos, pista contaminada, frenado menor que «bueno» o cortante de viento."
              },
              {
                "t": "Cualquiera, porque la restricción aplica solo al despegue",
                "fb": "Si el copiloto tiene menos de 100 horas en el tipo y el PIC no es instructor ni chequeador, el PIC hace todos los despegues y aterrizajes con viento cruzado de más de 15 nudos. También con visibilidad o RVR de 1.200 m o menos, pista contaminada, frenado menor que «bueno» o cortante de viento."
              },
              {
                "t": "Tú, porque el límite aplica a copilotos con menos de 50 h",
                "fb": "Si el copiloto tiene menos de 100 horas en el tipo y el PIC no es instructor ni chequeador, el PIC hace todos los despegues y aterrizajes con viento cruzado de más de 15 nudos. También con visibilidad o RVR de 1.200 m o menos, pista contaminada, frenado menor que «bueno» o cortante de viento."
              },
              {
                "t": "El PIC, porque el viento cruzado supera los 15 kt",
                "ok": true,
                "fb": "Si el copiloto tiene menos de 100 horas en el tipo y el PIC no es instructor ni chequeador, el PIC hace todos los despegues y aterrizajes con viento cruzado de más de 15 nudos. También con visibilidad o RVR de 1.200 m o menos, pista contaminada, frenado menor que «bueno» o cortante de viento."
              }
            ]
          ...
          {
            "q": "Según el Apéndice 18 del RAC 121, ¿cuántas horas de vuelo puede acumular como máximo un tripulante de vuelo de avión en un mes calendario?",
            "ref": "RAC 121, Apéndice 18, 1.1 (c)(2)(iv)(B)",
            "clave": "u10-q3",
            "opciones": [
              {
                "t": "85 horas",
                "fb": "El Apéndice 18 limita el tiempo de vuelo, medido «cuña a cuña», a 50 horas en la quincena, 90 en el mes, 270 en el trimestre y 1.000 en el año. Las 85 horas al mes son el límite de la aviación general en el RAC 91 (91.696)."
              },
              {
                "t": "100 horas",
                "fb": "El Apéndice 18 limita el tiempo de vuelo, medido «cuña a cuña», a 50 horas en la quincena, 90 en el mes, 270 en el trimestre y 1.000 en el año. Las 85 horas al mes son el límite de la aviación general en el RAC 91 (91.696)."
          ...
          {
            "q": "Asciendes a través de 8.000 ft y el despacho llama por la frecuencia de la empresa para confirmar las conexiones de los pasajeros. Según el RAC 121, ¿qué corresponde?",
            "ref": "RAC 121, 121.2255 (a) a (c)",
            "clave": "u10-q4",
            "opciones": [
              {
                "t": "No atenderla: es fase crítica por estar bajo 10.000 ft",
                "ok": true,
                "fb": "Son fases críticas el rodaje, el despegue, el aterrizaje y todo vuelo por debajo de 10.000 ft salvo el crucero, y en ellas no se atienden llamadas de la compañía como la confirmación de conexiones. Tampoco se permiten anuncios promocionales, formularios, comer ni conversar."
              },
              {
                "t": "Atenderla: en ascenso ya no es fase crítica de vuelo",
                "fb": "Son fases críticas el rodaje, el despegue, el aterrizaje y todo vuelo por debajo de 10.000 ft salvo el crucero, y en ellas no se atienden llamadas de la compañía como la confirmación de conexiones. Tampoco se permiten anuncios promocionales, formularios, comer ni conversar."
              },
              {
                "t": "Atenderla: la cabina estéril aplica solo bajo 3.000 ft",
                "fb": "Son fases críticas el rodaje, el despegue, el aterrizaje y todo vuelo por debajo de 10.000 ft salvo el crucero, y en ellas no se atienden llamadas de la compañía como la confirmación de conexiones. Tampoco se permiten anuncios promocionales, formularios, comer ni conversar."
              },
              {
                "t": "Atenderla, siempre que la conteste el piloto que no vuela",
                "fb": "Son fases críticas el rodaje, el despegue, el aterrizaje y todo vuelo por debajo de 10.000 ft salvo el crucero, y en ellas no se atienden llamadas de la compañía como la confirmación de conexiones. Tampoco se permiten anuncios promocionales, formularios, comer ni conversar."
              }
            ]
          }
  ...
  },
  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Según el RAC 135, si no tienes licencia de piloto de transporte de línea (PTL), ¿cuántas horas como piloto necesitas para ser designado PIC en operaciones IFR?",
            "ref": "RAC 135, 135.810 (b) y (c)",
            "clave": "u11-q1",
            "opciones": [
              {
                "t": "500 horas, con 100 de crucero",
                "fb": "Sin PTL, para IFR se piden 1.200 horas como piloto, con 500 de crucero y 75 de instrumentos (al menos 50 reales). Las 500 horas con 100 de crucero son el requisito para VFR."
              },
              {
                "t": "1.200 horas, con 500 de crucero",
                "ok": true,
                "fb": "Sin PTL, para IFR se piden 1.200 horas como piloto, con 500 de crucero y 75 de instrumentos (al menos 50 reales). Las 500 horas con 100 de crucero son el requisito para VFR."
              },
              {
                "t": "1.500 horas totales, con 500 de crucero",
                "fb": "Sin PTL, para IFR se piden 1.200 horas como piloto, con 500 de crucero y 75 de instrumentos (al menos 50 reales). Las 500 horas con 100 de crucero son el requisito para VFR."
              },
              {
                "t": "250 horas, con 50 de crucero",
                "fb": "Sin PTL, para IFR se piden 1.200 horas como piloto, con 500 de crucero y 75 de instrumentos (al menos 50 reales). Las 500 horas con 100 de crucero son el requisito para VFR."
              }
            ]
          },
          {
            "q": "Tu empresa RAC 135 opera un avión con 12 asientos de pasajeros y piloto automático aprobado en sus OpSpecs. Según el RAC 135, ¿puede volar sin copiloto?",
            "ref": "RAC 135, 135.255 (b) y 135.280 (a)",
            "clave": "u11-q2",
            "opciones": [
              {
                "t": "Sí, si el PIC tiene 100 horas en la misma marca y modelo",
                "fb": "El 135.255 exige copiloto con 10 o más asientos de pasajeros, y la excepción del piloto automático (135.280) no aplica a ese caso ni a la Categoría II. Las 100 horas en la misma marca y modelo son para usar el piloto automático en lugar del copiloto en IFR con pasajeros, fuera de esos casos."
              },
              {
                "t": "Sí, pero solo en VFR diurno y sin pasajeros a bordo",
                "fb": "El 135.255 exige copiloto con 10 o más asientos de pasajeros, y la excepción del piloto automático (135.280) no aplica a ese caso ni a la Categoría II. Las 100 horas en la misma marca y modelo son para usar el piloto automático en lugar del copiloto en IFR con pasajeros, fuera de esos casos."
              },
              {
                "t": "Sí, si es de hélice y vuela en IFR con aprobación",
                "fb": "El 135.255 exige copiloto con 10 o más asientos de pasajeros, y la excepción del piloto automático (135.280) no aplica a ese caso ni a la Categoría II. Las 100 horas en la misma marca y modelo son para usar el piloto automático en lugar del copiloto en IFR con pasajeros, fuera de esos casos."
              },
              {
                "t": "No: con 10 o más asientos el copiloto es obligatorio",
                "ok": true,
                "fb": "El 135.255 exige copiloto con 10 o más asientos de pasajeros, y la excepción del piloto automático (135.280) no aplica a ese caso ni a la Categoría II. Las 100 horas en la misma marca y modelo son para usar el piloto automático en lugar del copiloto en IFR con pasajeros, fuera de esos casos."
              }
            ]
  ...
  {
    "n": 12,
    "title": "Transporte sin riesgos de mercancías peligrosas por vía aérea",
    "kicker": "RAC 175",
    "minutes": 6,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Eres el PIC de un vuelo que lleva mercancías peligrosas como carga. ¿Qué te exige el RAC 175 sobre la información escrita que te entrega el explotador?",
            "ref": "RAC 175, 175.515 (a)(1) y (a)(2)",
            "clave": "u12-q1",
            "opciones": [
              {
                "t": "Leerla en el briefing; la firma y su custodia durante el vuelo quedan a cargo del despachador en tierra.",
                "fb": "El explotador te la entrega por escrito lo antes posible antes de la salida; tú la firmas antes de que se transporten las mercancías y debe estar a tu alcance durante el vuelo. La copia firmada que el explotador guarda en tierra no reemplaza la tuya."
              },
              {
                "t": "Firmarla al aterrizar y entregarla al explotador del aeródromo de destino.",
                "fb": "El explotador te la entrega por escrito lo antes posible antes de la salida; tú la firmas antes de que se transporten las mercancías y debe estar a tu alcance durante el vuelo. La copia firmada que el explotador guarda en tierra no reemplaza la tuya."
              },
              {
                "t": "Firmarla antes de que se transporten las mercancías y tenerla a tu alcance durante el vuelo.",
                "ok": true,
                "fb": "El explotador te la entrega por escrito lo antes posible antes de la salida; tú la firmas antes de que se transporten las mercancías y debe estar a tu alcance durante el vuelo. La copia firmada que el explotador guarda en tierra no reemplaza la tuya."
              },
              {
                "t": "Confirmarla por radio con ATS antes del despegue, sin necesidad de firmarla.",
                "fb": "El explotador te la entrega por escrito lo antes posible antes de la salida; tú la firmas antes de que se transporten las mercancías y debe estar a tu alcance durante el vuelo. La copia firmada que el explotador guarda en tierra no reemplaza la tuya."
              }
            ]
          },
          {
            "q": "Hiciste el curso inicial de mercancías peligrosas al ingresar a la aerolínea. Según el RAC 175, ¿cada cuánto, como mínimo, debes recibir de nuevo esa instrucción?",
            "ref": "RAC 175, 175.310 (a) y (b)",
            "clave": "u12-q2",
            "opciones": [
              {
                "t": "Cada 24 meses.",
                "ok": true,
                "fb": "La instrucción se imparte o se verifica al contratarte y se repite, como mínimo, cada 24 meses. Los 12 meses aparecen en el RAC 175, pero para los instructores de la Categoría 6 (175.320 (b))."
              },
              {
                "t": "Cada 12 meses.",
                "fb": "La instrucción se imparte o se verifica al contratarte y se repite, como mínimo, cada 24 meses. Los 12 meses aparecen en el RAC 175, pero para los instructores de la Categoría 6 (175.320 (b))."
              ...
              {
                "t": "Solo cuando cambias de equipo.",
                "fb": "La instrucción se imparte o se verifica al contratarte y se repite, como mínimo, cada 24 meses. Los 12 meses aparecen en el RAC 175, pero para los instructores de la Categoría 6 (175.320 (b))."
              }
            ]
          },
          {
            "q": "Durante el cargue ves en la bodega un bulto con la etiqueta «Exclusivamente en aeronaves de carga». Tu vuelo lleva pasajeros. ¿Qué establece el RAC 175?",
            "ref": "RAC 175, sección «Carga y estiba», literales (c) a (e)",
            "clave": "u12-q3",
            "opciones": [
              {
                "t": "Puede ir si se estiba lejos de la cabina y queda anotado en la información escrita al PIC.",
                "fb": "Los bultos con esa etiqueta no se estiban en aeronaves con pasajeros. Que un tripulante pueda verlos y manipularlos en vuelo es un requisito adicional para cuando van en una aeronave de carga, no una excepción."
              },
              {
                "t": "Puede ir si contiene cantidades exceptuadas y el explotador tiene autorización en sus OpSpecs.",
                "fb": "Los bultos con esa etiqueta no se estiban en aeronaves con pasajeros. Que un tripulante pueda verlos y manipularlos en vuelo es un requisito adicional para cuando van en una aeronave de carga, no una excepción."
              },
              {
                "t": "Puede ir si un tripulante puede verlo y manipularlo durante el vuelo.",
                "fb": "Los bultos con esa etiqueta no se estiban en aeronaves con pasajeros. Que un tripulante pueda verlos y manipularlos en vuelo es un requisito adicional para cuando van en una aeronave de carga, no una excepción."
              },
              {
                "t": "No puede estibarse en una aeronave ocupada por pasajeros.",
                "ok": true,
                "fb": "Los bultos con esa etiqueta no se estiban en aeronaves con pasajeros. Que un tripulante pueda verlos y manipularlos en vuelo es un requisito adicional para cuando van en una aeronave de carga, no una excepción."
              }
            ]
  ...
  {
    "n": 13,
    "title": "Seguridad de la aviación civil",
    "kicker": "RAC 160",
    "minutes": 7,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Según el RAC 160, ¿qué distingue a una persona insubordinada de una persona perturbadora?",
            "ref": "RAC 160, 160.005 («Persona disruptiva o perturbadora» y «Persona insubordinada»)",
            "clave": "u13-q1",
            "opciones": [
              {
                "t": "La perturbadora solo actúa a bordo; la insubordinada, solo en el aeropuerto.",
                "fb": "La insubordinación se define por el momento: a bordo, desde que se cierra la puerta antes del despegue hasta que se abre tras el aterrizaje. La persona perturbadora altera el orden o desobedece instrucciones en el aeropuerto o a bordo, sin esa ventana de tiempo."
              },
              {
                "t": "La insubordinada actúa a bordo entre el cierre de la puerta antes del despegue y su apertura al aterrizar.",
                "ok": true,
                "fb": "La insubordinación se define por el momento: a bordo, desde que se cierra la puerta antes del despegue hasta que se abre tras el aterrizaje. La persona perturbadora altera el orden o desobedece instrucciones en el aeropuerto o a bordo, sin esa ventana de tiempo."
              },
              {
                "t": "La insubordinada usa violencia física; la perturbadora solo incumple de palabra las instrucciones de la tripulación.",
                "fb": "La insubordinación se define por el momento: a bordo, desde que se cierra la puerta antes del despegue hasta que se abre tras el aterrizaje. La persona perturbadora altera el orden o desobedece instrucciones en el aeropuerto o a bordo, sin esa ventana de tiempo."
              },
              {
                "t": "Son sinónimos: el RAC 160 las trata como la misma categoría de pasajero.",
                "fb": "La insubordinación se define por el momento: a bordo, desde que se cierra la puerta antes del despegue hasta que se abre tras el aterrizaje. La persona perturbadora altera el orden o desobedece instrucciones en el aeropuerto o a bordo, sin esa ventana de tiempo."
              }
            ]
          },
          {
            "q": "Tu avión quedó estacionado 14 horas en plataforma durante la noche. Para el RAC 160, ¿cómo se considera esa aeronave?",
            "ref": "RAC 160, 160.005 («Aeronave que no está en servicio»)",
            "clave": "u13-q2",
            "opciones": [
              {
                "t": "En servicio, siempre que no tenga ítems MEL abiertos.",
                "fb": "No está en servicio la aeronave estacionada por más de 12 horas o la que no tiene vigilancia suficiente para detectar el acceso no autorizado; basta cualquiera de las dos condiciones."
              },
              {
                "t": "En servicio, porque todavía no supera las 24 horas.",
                "fb": "No está en servicio la aeronave estacionada por más de 12 horas o la que no tiene vigilancia suficiente para detectar el acceso no autorizado; basta cualquiera de las dos condiciones."
              },
              {
                "t": "No está en servicio, porque lleva más de 12 horas estacionada.",
                "ok": true,
                "fb": "No está en servicio la aeronave estacionada por más de 12 horas o la que no tiene vigilancia suficiente para detectar el acceso no autorizado; basta cualquiera de las dos condiciones."
              },
              {
                "t": "No está en servicio solo si además quedó sin vigilancia.",
                "fb": "No está en servicio la aeronave estacionada por más de 12 horas o la que no tiene vigilancia suficiente para detectar el acceso no autorizado; basta cualquiera de las dos condiciones."
              }
            ]
          },
          {
            "q": "Según el RAC 160, ¿en qué condiciones puede un explotador comercial transportar armas y municiones?",
            "ref": "RAC 160, 160.1400 (b) y 160.1415 (a)",
            "clave": "u13-q3",
            "opciones": [
              {
                "t": "Solo en bodega, descargadas, con legalidad verificada y en un lugar inaccesible durante el vuelo.",
                "ok": true,
                "fb": "Armas y municiones van solo en bodega, cuando la autoridad determinó que no están cargadas y verificó su legalidad, y en un lugar inaccesible durante el vuelo. En Colombia no se permiten armas ni personal armado en la cabina principal de aeronaves comerciales."
              },
              {
                "t": "En la cabina de pasajeros, siempre que las porte personal armado autorizado por la empresa aérea.",
                "fb": "Armas y municiones van solo en bodega, cuando la autoridad determinó que no están cargadas y verificó su legalidad, y en un lugar inaccesible durante el vuelo. En Colombia no se permiten armas ni personal armado en la cabina principal de aeronaves comerciales."
              },
              {
                "t": "En la cabina de mando, bajo la custodia directa del piloto al mando.",
                "fb": "Armas y municiones van solo en bodega, cuando la autoridad determinó que no están cargadas y verificó su legalidad, y en un lugar inaccesible durante el vuelo. En Colombia no se permiten armas ni personal armado en la cabina principal de aeronaves comerciales."
              },
              {
                "t": "En el equipaje de mano, si el pasajero presenta su permiso de porte vigente.",
                "fb": "Armas y municiones van solo en bodega, cuando la autoridad determinó que no están cargadas y verificó su legalidad, y en un lugar inaccesible durante el vuelo. En Colombia no se permiten armas ni personal armado en la cabina principal de aeronaves comerciales."
              }
            ]
          }
  ...
  {
    "n": 14,
    "title": "Gestión de la seguridad operacional",
    "kicker": "RAC 219",
    "minutes": 4,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "En el vocabulario del RAC 219, ¿qué es el «riesgo de seguridad operacional»?",
            "ref": "RAC 219, 219.001 («Riesgo de seguridad operacional», «Peligro» y «Mitigación de riesgos»)",
            "clave": "u14-q1",
            "opciones": [
              {
                "t": "La condición u objeto que puede causar un incidente o accidente, o contribuir a él.",
                "fb": "El riesgo se expresa en probabilidad y severidad de las consecuencias de un peligro. La condición u objeto que puede causar un incidente o accidente es el peligro, y poner defensas o controles para reducir la consecuencia es la mitigación."
              },
              {
                "t": "El nivel aceptable de seguridad que fija la Aerocivil para cada proveedor.",
                "fb": "El riesgo se expresa en probabilidad y severidad de las consecuencias de un peligro. La condición u objeto que puede causar un incidente o accidente es el peligro, y poner defensas o controles para reducir la consecuencia es la mitigación."
              },
              {
                "t": "El proceso de poner defensas o controles para reducir la gravedad de un peligro.",
                "fb": "El riesgo se expresa en probabilidad y severidad de las consecuencias de un peligro. La condición u objeto que puede causar un incidente o accidente es el peligro, y poner defensas o controles para reducir la consecuencia es la mitigación."
              },
              {
                "t": "La probabilidad y la severidad previstas de las consecuencias de un peligro.",
                "ok": true,
                "fb": "El riesgo se expresa en probabilidad y severidad de las consecuencias de un peligro. La condición u objeto que puede causar un incidente o accidente es el peligro, y poner defensas o controles para reducir la consecuencia es la mitigación."
              }
            ]
          ...
          {
            "q": "¿Cuáles son los cuatro componentes de un SMS según el RAC 219?",
            "ref": "RAC 219, 219.105",
            "clave": "u14-q2",
            "opciones": [
              {
                "t": "Instrucción, comunicación, gestión del cambio y mejora continua.",
                "fb": "El SMS tiene 4 componentes y 12 elementos. Instrucción, comunicación, gestión del cambio y mejora continua son elementos dentro de los componentes de aseguramiento y promoción, no componentes."
              },
              {
                "t": "Política y objetivos, gestión de riesgos, aseguramiento y promoción de la seguridad.",
                "ok": true,
                "fb": "El SMS tiene 4 componentes y 12 elementos. Instrucción, comunicación, gestión del cambio y mejora continua son elementos dentro de los componentes de aseguramiento y promoción, no componentes."
              },
              {
                "t": "Prevención, investigación, sanción y divulgación de los sucesos.",
                "fb": "El SMS tiene 4 componentes y 12 elementos. Instrucción, comunicación, gestión del cambio y mejora continua son elementos dentro de los componentes de aseguramiento y promoción, no componentes."
              },
              {
                "t": "Identificación de peligros, notificación obligatoria, auditoría y análisis de datos de vuelo.",
                "fb": "El SMS tiene 4 componentes y 12 elementos. Instrucción, comunicación, gestión del cambio y mejora continua son elementos dentro de los componentes de aseguramiento y promoción, no componentes."
              }
            ]
          }
  ...
  {
    "n": 15,
    "title": "Investigación de accidentes e incidentes de aviación",
    "kicker": "RAC 114",
    "minutes": 7,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Según el RAC 114, ¿cuál es el único objetivo de investigar un accidente o incidente de aviación?",
            "ref": "RAC 114, 114.200 (a)",
            "clave": "u15-q1",
            "opciones": [
              {
                "t": "Prevenir futuros accidentes e incidentes.",
                "ok": true,
                "fb": "El único objetivo es la prevención; la investigación no busca determinar culpa ni responsabilidad. Si el investigador detecta una posible infracción, la traslada a la dependencia sancionadora, que actúa por separado (RAC 13, 13.1020)."
              },
              {
                "t": "Determinar la culpa y la responsabilidad de los involucrados.",
                "fb": "El único objetivo es la prevención; la investigación no busca determinar culpa ni responsabilidad. Si el investigador detecta una posible infracción, la traslada a la dependencia sancionadora, que actúa por separado (RAC 13, 13.1020)."
              },
              {
                "t": "Fijar la sanción que corresponde al explotador o a la tripulación.",
                "fb": "El único objetivo es la prevención; la investigación no busca determinar culpa ni responsabilidad. Si el investigador detecta una posible infracción, la traslada a la dependencia sancionadora, que actúa por separado (RAC 13, 13.1020)."
              },
              {
                "t": "Establecer el monto de las indemnizaciones del seguro.",
                "fb": "El único objetivo es la prevención; la investigación no busca determinar culpa ni responsabilidad. Si el investigador detecta una posible infracción, la traslada a la dependencia sancionadora, que actúa por separado (RAC 13, 13.1020)."
              }
            ]
          },
          {
            "q": "Eres copiloto y tu tripulación estuvo involucrada en un incidente. Salvo fuerza mayor, ¿en qué plazo deben comunicarse con la autoridad de investigación de accidentes (AIG)?",
            "ref": "RAC 114, 114.335 (a)",
            "clave": "u15-q2",
            "opciones": [
              {
                "t": "Dentro de las 2 horas siguientes.",
                "fb": "Toda tripulación involucrada en un suceso se comunica con la AIG dentro de las 12 horas siguientes, por teléfono o cualquier otro medio, salvo fuerza mayor por las lesiones o por la ubicación y condición de la aeronave. Las 2 horas son el plazo del servicio de búsqueda y salvamento (114.325 (a))."
              },
              {
                "t": "Dentro de las 24 horas siguientes.",
                "fb": "Toda tripulación involucrada en un suceso se comunica con la AIG dentro de las 12 horas siguientes, por teléfono o cualquier otro medio, salvo fuerza mayor por las lesiones o por la ubicación y condición de la aeronave. Las 2 horas son el plazo del servicio de búsqueda y salvamento (114.325 (a))."
              },
              {
                "t": "Dentro de las 72 horas siguientes.",
                "fb": "Toda tripulación involucrada en un suceso se comunica con la AIG dentro de las 12 horas siguientes, por teléfono o cualquier otro medio, salvo fuerza mayor por las lesiones o por la ubicación y condición de la aeronave. Las 2 horas son el plazo del servicio de búsqueda y salvamento (114.325 (a))."
              },
              {
                "t": "Dentro de las 12 horas siguientes.",
                "ok": true,
                "fb": "Toda tripulación involucrada en un suceso se comunica con la AIG dentro de las 12 horas siguientes, por teléfono o cualquier otro medio, salvo fuerza mayor por las lesiones o por la ubicación y condición de la aeronave. Las 2 horas son el plazo del servicio de búsqueda y salvamento (114.325 (a))."
              }
            ]
          ...
          {
            "q": "Según el RAC 114, ¿qué diferencia a un incidente grave de un accidente?",
            "ref": "RAC 114, 114.001 («Incidente grave» y su Nota 1)",
            "clave": "u15-q3",
            "opciones": [
              {
                "t": "El incidente grave solo puede ocurrir con la aeronave en tierra.",
                "fb": "En el incidente grave hubo alta probabilidad de que ocurriera un accidente; la diferencia con el accidente está solo en el resultado. Las lesiones mortales o graves son uno de los criterios del accidente, no del incidente grave."
              },
              {
                "t": "El incidente grave exige que alguien sufra lesiones graves.",
                "fb": "En el incidente grave hubo alta probabilidad de que ocurriera un accidente; la diferencia con el accidente está solo en el resultado. Las lesiones mortales o graves son uno de los criterios del accidente, no del incidente grave."
              },
              {
                "t": "Solo el resultado: hubo alta probabilidad de accidente, pero no llegó a serlo.",
                "ok": true,
                "fb": "En el incidente grave hubo alta probabilidad de que ocurriera un accidente; la diferencia con el accidente está solo en el resultado. Las lesiones mortales o graves son uno de los criterios del accidente, no del incidente grave."
              },
              {
                "t": "El incidente grave solo aplica a aeronaves de más de 5.700 kg.",
                "fb": "En el incidente grave hubo alta probabilidad de que ocurriera un accidente; la diferencia con el accidente está solo en el resultado. Las lesiones mortales o graves son uno de los criterios del accidente, no del incidente grave."
              }
            ]
          }
  ...
  },
  {
    ...
    "blocks": [
      ...
      },
      {
        "kind": "list",
        "items": [
          "**Atenuantes** (13.300 (a)), cada uno reduce la multa **16,66 %**, hasta un **50 %** en total: 1. No tener sanciones en los **3 años** anteriores. 2. **Presentarte voluntariamente** ante la autoridad e informar la falta (el «autorreporte» que reconoce el RAC 13). 3. Cualquier otra circunstancia demostrable que haga la falta menos gravosa, sin riesgo para la seguridad ni perjuicio a terceros.",
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Cometiste una infracción técnica que no tuvo consecuencias. Según el RAC 13, ¿cuál de estas actuaciones tuyas cuenta como atenuante?",
            "ref": "RAC 13, 13.300 (a)(2) y parágrafo; 13.300 (b)",
            "clave": "u16-q1",
            "opciones": [
              {
                "t": "Haberla cometido para ocultar otra falta anterior.",
                "fb": "Presentarse voluntariamente e informar la falta es atenuante y reduce la multa un 16,66 %. Las otras tres son agravantes, que la aumentan."
              },
              {
                "t": "Presentarte voluntariamente ante la autoridad e informar la falta.",
                "ok": true,
                "fb": "Presentarse voluntariamente e informar la falta es atenuante y reduce la multa un 16,66 %. Las otras tres son agravantes, que la aumentan."
              },
              {
                "t": "Haber aprovechado una situación de calamidad o infortunio para cometerla.",
                "fb": "Presentarse voluntariamente e informar la falta es atenuante y reduce la multa un 16,66 %. Las otras tres son agravantes, que la aumentan."
              },
              {
                "t": "Haber actuado en coparticipación con otro tripulante.",
                "fb": "Presentarse voluntariamente e informar la falta es atenuante y reduce la multa un 16,66 %. Las otras tres son agravantes, que la aumentan."
              }
            ]
          },
          {
            "q": "Te notifican personalmente un pliego de cargos por una infracción técnica. Según el RAC 13, ¿cuánto tiempo tienes para presentar descargos y pedir pruebas?",
            "ref": "RAC 13, 13.2045 (b)",
            "clave": "u16-q2",
            "opciones": [
              {
                "t": "5 días.",
                "fb": "Tienes 10 días desde la notificación para presentar descargos y solicitar pruebas. Los 5 días son el plazo para pagar con reducción a la mitad (13.2085) y los 15 días hábiles, el máximo para revisar una medida preventiva (13.1075 (d))."
              },
              {
                "t": "15 días hábiles.",
                "fb": "Tienes 10 días desde la notificación para presentar descargos y solicitar pruebas. Los 5 días son el plazo para pagar con reducción a la mitad (13.2085) y los 15 días hábiles, el máximo para revisar una medida preventiva (13.1075 (d))."
          ...
          {
            "q": "¿En cuánto tiempo caduca la facultad de la Aerocivil para sancionar una infracción, según el RAC 13?",
            "ref": "RAC 13, 13.2015",
            "clave": "u16-q3",
            "opciones": [
              {
                "t": "1 año desde el hecho.",
                "fb": "La facultad de sancionar caduca a los 3 años de ocurrido el hecho. Los 5 años son la prescripción de una sanción ya decretada, contados desde su ejecutoria."
              },
              {
                "t": "5 años desde el hecho.",
                "fb": "La facultad de sancionar caduca a los 3 años de ocurrido el hecho. Los 5 años son la prescripción de una sanción ya decretada, contados desde su ejecutoria."
              },
              {
                "t": "3 años desde la notificación del pliego de cargos.",
                "fb": "La facultad de sancionar caduca a los 3 años de ocurrido el hecho. Los 5 años son la prescripción de una sanción ya decretada, contados desde su ejecutoria."
              },
              {
                "t": "3 años desde el hecho.",
                "ok": true,
                "fb": "La facultad de sancionar caduca a los 3 años de ocurrido el hecho. Los 5 años son la prescripción de una sanción ya decretada, contados desde su ejecutoria."
              }
            ]
  ...
  {
    "n": 17,
    "title": "Cuestiones preliminares, disposiciones iniciales, definiciones y abreviaturas",
    "kicker": "RAC 1",
    "minutes": 10,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Estudias el manual de tu aerolínea y ves que el RAC 121 define «aeródromo alterno» de forma distinta al RAC 1. Según el RAC 1, ¿cuál definición aplica a la operación?",
            "ref": "RAC 1, 1.2 (párrafos sobre discrepancia entre definiciones)",
            "clave": "u17-q1",
            "opciones": [
              {
                "t": "La del RAC 121, porque la del RAC particular prevalece en sus asuntos.",
                "ok": true,
                "fb": "Si hay discrepancia, prevalece la definición del RAC particular sobre la del RAC 1, pero solo para los asuntos propios de ese RAC. Si un RAC no define una palabra, se entiende como la define el RAC 1."
              },
              {
                "t": "La del RAC 1, porque es la definición general de todos los RAC.",
                "fb": "Si hay discrepancia, prevalece la definición del RAC particular sobre la del RAC 1, pero solo para los asuntos propios de ese RAC. Si un RAC no define una palabra, se entiende como la define el RAC 1."
              },
              {
                "t": "La más reciente de las dos, según la fecha de su enmienda.",
                "fb": "Si hay discrepancia, prevalece la definición del RAC particular sobre la del RAC 1, pero solo para los asuntos propios de ese RAC. Si un RAC no define una palabra, se entiende como la define el RAC 1."
              },
              {
                "t": "La del Anexo 6 de la OACI, porque las dos normas colombianas la adoptan.",
                "fb": "Si hay discrepancia, prevalece la definición del RAC particular sobre la del RAC 1, pero solo para los asuntos propios de ese RAC. Si un RAC no define una palabra, se entiende como la define el RAC 1."
              }
            ]
          },
          {
            "q": "Según las definiciones del RAC 1, ¿cuál es la diferencia entre la altitud de decisión (DA) y la altura de decisión (DH)?",
            "ref": "RAC 1, 1.2.1 («Altitud de decisión»)",
            "clave": "u17-q2",
            "opciones": [
              {
                "t": "La DA se usa en aproximaciones que no son de precisión y la DH en las de precisión.",
                "fb": "Las dos marcan el punto de la aproximación de precisión en que se inicia la frustrada si no hay referencia visual; la DA se mide respecto al nivel medio del mar y la DH, respecto a la zona de toma de contacto. Para aproximaciones sin senda electrónica se usa la MDA."
              },
              {
                "t": "La DA va referida al nivel medio del mar; la DH, a la zona de toma de contacto.",
                "ok": true,
                "fb": "Las dos marcan el punto de la aproximación de precisión en que se inicia la frustrada si no hay referencia visual; la DA se mide respecto al nivel medio del mar y la DH, respecto a la zona de toma de contacto. Para aproximaciones sin senda electrónica se usa la MDA."
              },
              {
                "t": "La DA se expresa en metros y la DH en pies, pero indican el mismo punto.",
                "fb": "Las dos marcan el punto de la aproximación de precisión en que se inicia la frustrada si no hay referencia visual; la DA se mide respecto al nivel medio del mar y la DH, respecto a la zona de toma de contacto. Para aproximaciones sin senda electrónica se usa la MDA."
              },
              {
                "t": "La DA va referida a la elevación del aeródromo y la DH al nivel medio del mar.",
                "fb": "Las dos marcan el punto de la aproximación de precisión en que se inicia la frustrada si no hay referencia visual; la DA se mide respecto al nivel medio del mar y la DH, respecto a la zona de toma de contacto. Para aproximaciones sin senda electrónica se usa la MDA."
              }
            ]
          },
          {
            "q": "Según el RAC 1, ¿cuándo empieza y cuándo termina el tiempo de vuelo de la tripulación?",
            "ref": "RAC 1, 1.2.1 («Tiempo de vuelo»)",
            "clave": "u17-q3",
            "opciones": [
              {
                "t": "Desde el despegue hasta el aterrizaje siguiente.",
                "fb": "Para la tripulación el tiempo de vuelo es «de cuña a cuña»: desde que la aeronave empieza a moverse con el propósito de despegar hasta que se detiene. Del despegue al aterrizaje es el tiempo de vuelo de la aeronave, y contar desde la presentación hasta el relevo de todo servicio se parece al período de servicio de vuelo."
              },
              {
                "t": "Desde que te presentas en el aeropuerto para el servicio hasta que quedas relevado de todo servicio.",
                "fb": "Para la tripulación el tiempo de vuelo es «de cuña a cuña»: desde que la aeronave empieza a moverse con el propósito de despegar hasta que se detiene. Del despegue al aterrizaje es el tiempo de vuelo de la aeronave, y contar desde la presentación hasta el relevo de todo servicio se parece al período de servicio de vuelo."
              },
              {
                "t": "Desde el encendido de los motores hasta que se apaga la APU en plataforma.",
                "fb": "Para la tripulación el tiempo de vuelo es «de cuña a cuña»: desde que la aeronave empieza a moverse con el propósito de despegar hasta que se detiene. Del despegue al aterrizaje es el tiempo de vuelo de la aeronave, y contar desde la presentación hasta el relevo de todo servicio se parece al período de servicio de vuelo."
              },
              {
                "t": "Desde que la aeronave empieza a moverse para despegar hasta que se detiene al final del vuelo.",
                "ok": true,
                "fb": "Para la tripulación el tiempo de vuelo es «de cuña a cuña»: desde que la aeronave empieza a moverse con el propósito de despegar hasta que se detiene. Del despegue al aterrizaje es el tiempo de vuelo de la aeronave, y contar desde la presentación hasta el relevo de todo servicio se parece al período de servicio de vuelo."
              }
            ]
  ...
  {
    "n": 18,
    "title": "Telecomunicaciones aeronáuticas",
    "kicker": "RAC 210",
    "minutes": 2,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Una aeronave militar te intercepta y necesitas establecer comunicación por VHF. Según el RAC 210, ¿qué canal está previsto para esa comunicación?",
            "ref": "RAC 210, 210.620 (f)",
            "clave": "u18-q1",
            "opciones": [
              {
                "t": "123,450 MHz, canal aire-aire.",
                "fb": "El canal de emergencia 121,500 MHz se usa solo para verdaderas emergencias, y una de ellas es la comunicación entre aeronaves civiles e interceptoras. 123,45 MHz es aire-aire en zonas remotas y 123,1 MHz, auxiliar de búsqueda y salvamento."
              },
              {
                "t": "123,100 MHz, auxiliar de búsqueda y salvamento.",
                "fb": "El canal de emergencia 121,500 MHz se usa solo para verdaderas emergencias, y una de ellas es la comunicación entre aeronaves civiles e interceptoras. 123,45 MHz es aire-aire en zonas remotas y 123,1 MHz, auxiliar de búsqueda y salvamento."
              },
              {
                "t": "121,500 MHz, canal de emergencia.",
                "ok": true,
                "fb": "El canal de emergencia 121,500 MHz se usa solo para verdaderas emergencias, y una de ellas es la comunicación entre aeronaves civiles e interceptoras. 123,45 MHz es aire-aire en zonas remotas y 123,1 MHz, auxiliar de búsqueda y salvamento."
              },
              {
                "t": "118,000 MHz, primera frecuencia VHF asignable.",
                "fb": "El canal de emergencia 121,500 MHz se usa solo para verdaderas emergencias, y una de ellas es la comunicación entre aeronaves civiles e interceptoras. 123,45 MHz es aire-aire en zonas remotas y 123,1 MHz, auxiliar de búsqueda y salvamento."
              }
            ]
          },
          {
            "q": "Según el RAC 210, ¿en qué frecuencias debe funcionar un transmisor de localización de emergencia (ELT)?",
            "ref": "RAC 210, 210.600 (a)(1)",
            "clave": "u18-q2",
            "opciones": [
              {
                "t": "406 MHz y 121,500 MHz.",
                "ok": true,
                "fb": "Todo ELT debe funcionar tanto en 406 MHz como en 121,500 MHz; cuándo es obligatorio llevarlo lo dicen los RAC 91, 121 y 135. 3.023 kHz y 5.680 kHz son las frecuencias HF de búsqueda y salvamento en el lugar del accidente."
              },
              {
                "t": "121,500 MHz y 243,000 MHz.",
                "fb": "Todo ELT debe funcionar tanto en 406 MHz como en 121,500 MHz; cuándo es obligatorio llevarlo lo dicen los RAC 91, 121 y 135. 3.023 kHz y 5.680 kHz son las frecuencias HF de búsqueda y salvamento en el lugar del accidente."
              },
              {
                "t": "406 MHz y 123,100 MHz.",
                "fb": "Todo ELT debe funcionar tanto en 406 MHz como en 121,500 MHz; cuándo es obligatorio llevarlo lo dicen los RAC 91, 121 y 135. 3.023 kHz y 5.680 kHz son las frecuencias HF de búsqueda y salvamento en el lugar del accidente."
              },
              {
                "t": "3.023 kHz y 5.680 kHz.",
                "fb": "Todo ELT debe funcionar tanto en 406 MHz como en 121,500 MHz; cuándo es obligatorio llevarlo lo dicen los RAC 91, 121 y 135. 3.023 kHz y 5.680 kHz son las frecuencias HF de búsqueda y salvamento en el lugar del accidente."
              }
            ]
          }
  ...
  {
    "n": 19,
    "title": "Normas de aeronavegabilidad y operación de aeronaves",
    "kicker": "RAC 4",
    "minutes": 3,
    "blocks": [
      {
      ...
      },
      {
        ...
        "preguntas": [
          {
            "q": "Vas a ingresar a una aerolínea colombiana que opera aviones de más de 19 pasajeros. ¿Qué normas rigen hoy su certificación y su operación?",
            "ref": "RAC 121, Normas transitorias, Artículo Segundo (c)",
            "clave": "u19-q1",
            "opciones": [
              {
                "t": "El RAC 4, que sigue vigente para las empresas certificadas antes de 2016.",
                "fb": "Los capítulos operativos del RAC 4 siguieron vigentes para las empresas en transición solo hasta el 31 de mayo de 2026; hoy la aerolínea se certifica por el RAC 119 y opera por el RAC 121. El RAC 135 es para aviones de 19 pasajeros o menos y 5.700 kg o menos."
              },
              {
                "t": "El RAC 119 y el RAC 121; el régimen de transición del RAC 4 ya terminó.",
                "ok": true,
                "fb": "Los capítulos operativos del RAC 4 siguieron vigentes para las empresas en transición solo hasta el 31 de mayo de 2026; hoy la aerolínea se certifica por el RAC 119 y opera por el RAC 121. El RAC 135 es para aviones de 19 pasajeros o menos y 5.700 kg o menos."
              },
              {
                "t": "El RAC 135 y el RAC 91, mientras la empresa no complete su transición.",
                "fb": "Los capítulos operativos del RAC 4 siguieron vigentes para las empresas en transición solo hasta el 31 de mayo de 2026; hoy la aerolínea se certifica por el RAC 119 y opera por el RAC 121. El RAC 135 es para aviones de 19 pasajeros o menos y 5.700 kg o menos."
              },
              {
                "t": "El RAC 4 para operaciones nacionales y el RAC 121 para las internacionales.",
                "fb": "Los capítulos operativos del RAC 4 siguieron vigentes para las empresas en transición solo hasta el 31 de mayo de 2026; hoy la aerolínea se certifica por el RAC 119 y opera por el RAC 121. El RAC 135 es para aviones de 19 pasajeros o menos y 5.700 kg o menos."
              }
            ]
          },
          {
            "q": "Según las normas transitorias del RAC 121, ¿qué debía hacer una empresa certificada bajo el RAC 4 que no cerró la fase 3 de su actualización en el plazo final?",
            "ref": "RAC 121, Normas transitorias, Artículo 3",
            "clave": "u19-q2",
            "opciones": [
              {
                "t": "Seguir operando bajo el RAC 4 con una multa por cada mes de retraso.",
                "fb": "El Artículo 3 ordena el cese de actividades de vuelo a quien no cerró la fase 3 al 1 de junio de 2025, o a la fecha final si se le repusieron términos. No prevé multa ni operación restringida como alternativa."
              },
              {
                "t": "Pasar automáticamente al RAC 135 hasta terminar el proceso.",
                "fb": "El Artículo 3 ordena el cese de actividades de vuelo a quien no cerró la fase 3 al 1 de junio de 2025, o a la fecha final si se le repusieron términos. No prevé multa ni operación restringida como alternativa."
              },
              {
                "t": "Cesar sus actividades de vuelo.",
                "ok": true,
                "fb": "El Artículo 3 ordena el cese de actividades de vuelo a quien no cerró la fase 3 al 1 de junio de 2025, o a la fecha final si se le repusieron términos. No prevé multa ni operación restringida como alternativa."
              },
              {
                "t": "Operar solo vuelos nacionales hasta cerrar la fase 3.",
                "fb": "El Artículo 3 ordena el cese de actividades de vuelo a quien no cerró la fase 3 al 1 de junio de 2025, o a la fecha final si se le repusieron términos. No prevé multa ni operación restringida como alternativa."
              }
            ]
          }
...
export const RAC_LECCION_TOTAL = 19
 ...
 */
export const RAC_PRACTICA_CLAVES = [
  "u01-q1",
  "u01-q2",
  "u01-q3",
  "u01-q4",
...
export const RAC_FIGURAS_PENDIENTES = []
