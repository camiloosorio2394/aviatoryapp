...
export const MEL_LEE_LA_ENTRADA: EjLeeLaEntrada[] = [
  {
    ...
    pasos: [
      { tipo: "toca", id: "cat", enunciado: "Toca la categoría de reparación de esta fila.", parte: "categoria" },
      {
        ...
        opciones: ["Que no hay ninguno instalado", "Que el número instalado es variable", "Que no aplica a este avión", "Que el dato está borrado"],
        correctas: [1],
      },
      {
        tipo: "elige",
        ...
        opciones: [
          "3 días calendario, como cualquier categoría B",
          "El que dice Remarks: 3 flight-days, sin contar el día en que se anotó",
          "10 días calendario",
          "3 vuelos desde que se difirió",
        ],
        correctas: [1],
      },
  ...
  },
  {
    ...
    pasos: [
      { tipo: "toca", id: "req", enunciado: "Toca el número requerido para despacho de la fila que aplica.", parte: "requeridos" },
      {
        ...
        opciones: [
          "Porque es de otra configuración",
  ...
  },
  {
    ...
    pasos: [
      { tipo: "toca", id: "proc", enunciado: "Toca lo que te dice que hay un procedimiento para la tripulación.", parte: "procedimientos" },
      {
        ...
        opciones: ["1) Landing Lights", "2) Extension/Retraction Systems", "El ítem completo 33-40-02", "Ninguno: no hay alivio"],
        correctas: [1],
      },
      {
        tipo: "elige",
  ...
  },
  {
    ...
    pasos: [
      ...
      },
      {
        ...
        opciones: ["La tripulación en el prevuelo", "Mantenimiento, por el (M)", "Despacho", "Nadie: es informativa"],
        correctas: [1],
      },
    ],
    explicacion:
    ...
    pasos: [
      { tipo: "toca", id: "codigo", enunciado: "Toca la secuencia de la fila que aplica a un avión de pasajeros.", parte: "codigo" },
      {
        ...
        opciones: [
          ...
          "Que no aplica a aviones de pasajeros",
          "Que se requiere uno por lavabo",
        ],
        correctas: [1],
      },
      {
  ...
  },
  {
    ...
    pasos: [
      { tipo: "toca", id: "codigo", enunciado: "Toca la secuencia de la fila de este calefactor.", parte: "codigo" },
      {
        ...
        opciones: ["A todos los B737", "-100 a -500", "-600 a -900ER", "Solo al -300"],
        correctas: [1],
      },
      {
        tipo: "elige",
        ...
        opciones: ["72 horas desde la hora del reporte", "3 días calendario, sin contar el día en que se anotó", "3 vuelos", "10 días"],
        correctas: [1],
      },
      {
        tipo: "elige",
  ...
  },
  {
    ...
    pasos: [
      ...
      },
      {
        ...
        opciones: ["El sistema hidráulico 3", "La indicación de cantidad de un depósito", "La bomba del sistema 3", "El depósito"],
        correctas: [1],
      },
    ],
    explicacion:
  ...
  },
  {
    ...
    pasos: [
      { tipo: "toca", id: "inst", enunciado: "Toca el número instalado.", parte: "instalados" },
      {
        ...
        opciones: ["Ninguno", "Todos", "Al menos uno en cada estación de auxiliar requerida, según Remarks", "Uno en todo el avión"],
        correctas: [2],
      },
      { tipo: "elige", id: "o", campo: "o", enunciado: "¿Hay (O)?", opciones: SI_NO, correctas: [0] },
      { tipo: "elige", id: "cat", campo: "categoria", enunciado: "¿Categoría?", opciones: ["A", "B", "C", "D"], correctas: [2] },
    ...
    pasos: [
      { tipo: "toca", id: "proc", enunciado: "Toca los procedimientos asociados.", parte: "procedimientos" },
      {
        ...
        opciones: [
          ...
          "La tripulación desactiva el galley",
          "Mantenimiento hace todo",
          "Nadie: es categoría C",
        ],
        correctas: [0],
      },
    ...
    pasos: [
      {
        ...
        opciones: ["La C: excluye todo ETOPS", "La A: excluye solo ETOPS de más de 120 minutos", "Ninguna", "Las dos"],
        correctas: [1],
      },
      { tipo: "toca", id: "cat", enunciado: "Toca la categoría de la fila que aplica.", parte: "categoria" },
      {
        ...
        opciones: ["A la 0000 del día siguiente", "Cuando se difiere el ítem", "Al primer vuelo ETOPS", "Al terminar el día"],
        correctas: [1],
      },
      {
        tipo: "elige",
        ...
        opciones: ["Agrega una condición", "Informa cómo se puede arrancar la APU", "Prohíbe arrancar la APU", "Cambia la categoría"],
        correctas: [1],
      },
    ],
    explicacion:
...
export const MEL_CALCULA_EL_PLAZO: EjCalculaElPlazo[] = [
  {
    ...
    cuenta: "local",
    opciones: ["2026-01-28T23:59", "2026-01-29T10:00", "2026-01-29T23:59", "2026-01-30T23:59"],
  ...
  },
  {
    ...
    cuenta: "local",
    opciones: ["2026-06-30T23:59", "2026-07-01T16:45", "2026-07-01T23:59", "2026-07-03T23:59"],
  ...
  },
  {
    ...
    cuenta: "UTC",
    opciones: ["2026-08-24T23:59", "2026-08-25T21:30", "2026-08-25T23:59", "2026-08-26T23:59"],
  ...
  },
  {
    ...
    cuenta: "local",
    opciones: ["2028-02-29T23:59", "2028-03-01T08:00", "2028-03-01T23:59", "2028-03-02T23:59"],
  ...
  },
  {
    ...
    cuenta: "local",
    opciones: ["2026-04-08T19:10", "2026-04-08T23:59", "2026-04-09T23:59", "2026-04-10T23:59"],
  ...
  },
  {
    ...
    cuenta: "local",
    opciones: ["2027-01-05T23:59", "2027-01-06T03:15", "2027-01-06T23:59", "2027-01-07T23:59"],
...
export const MEL_COMBINADOS: EjCombinados[] = [
  {
    ...
    dependencia: {
      opciones: [
        ...
        "Las dos piden (M)",
        "No se cruzan: cada una se lee por su lado",
        "El sangrado exige que la PRV funcione",
      ],
      correcta: 0,
    },
  ...
  },
  {
    ...
    dependencia: {
      opciones: [
        ...
        "El ADR 3 pide que funcionen los dos RA",
        "Los dos son categoría A",
        "No hay relación: los dos tienen alivio",
      ],
      correcta: 0,
    },
  ...
  },
  {
    ...
    dependencia: {
      opciones: [
        "La primera fila de las luces de aterrizaje pide las de rodaje y despegue operando; como no, queda la fila «non-night»",
        "La luz de rodaje pide las de aterrizaje",
        "No se cruzan",
        "Las dos son D",
      ],
      correcta: 0,
  ...
  },
  {
    ...
    dependencia: {
      opciones: [
        "La fila «B 2 1» del limpiaparabrisas pide el repelente operativo; como no, se usa la fila C 2 0 con sus condiciones",
        "El repelente pide el limpiaparabrisas",
        "No se cruzan",
        "La fila C 2 0 exige los dos operativos",
      ],
      correcta: 0,
    },
  ...
  },
  {
    ...
    dependencia: {
      opciones: [
        ...
        "El autopiloto pide la alerta de altitud",
        "Los dos piden (M)",
        "No se cruzan",
      ],
      correcta: 0,
  ...
  },
  {
    ...
    dependencia: {
      opciones: [
        "El alivio del fuel used pide la indicación de cantidad de todos los tanques, y la del central no funciona",
        "El tanque central pide el fuel used",
        "Los dos son C",
        "No se cruzan",
      ],
      correcta: 0,
  ...
  },
  {
    ...
    dependencia: {
      opciones: [
        ...
        "El altavoz pide la indicación de agua",
        "Los dos son D",
        "La indicación de agua pide los headsets",
      ],
      correcta: 0,
    },
  ...
  },
  {
    ...
    dependencia: {
      opciones: [
        ...
        "Las luces de lectura piden el sangrado",
        "El sangrado de la APU pide los dos motores",
        "No se cruzan",
      ],
      correcta: 0,
    },
  ...
  },
  {
    ...
    dependencia: {
      opciones: [
        "La secundaria pide la primaria operando normalmente, y una indicación intermitente se considera inoperativa",
        "La primaria no tiene nada que ver",
        "Basta con que funcione en tierra",
        "Las dos son C, así que se suman",
      ],
      correcta: 0,
    },
