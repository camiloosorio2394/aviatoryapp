...
const G = {
  ...
  cpContactoAlexander: tx(
    ...
    "atc_us",
    "limpia",
    "Aviatory four five two, contact Alexander Control one two six decimal three.",
  ),
  cpPreveaIls14: tx(
    "cm-cp-prevea-ils-14",
    "atc_uk",
    "limpia",
    "Aviatory four five two, expect ILS approach runway one four, QNH one zero one eight.",
  ),
  cpInfoSalida19: tx(
    "cm-cp-info-salida-19",
    "atc_latam",
    "normal",
    "Aviatory four five two, departure runway one niner, wind one seven zero degrees six knots, QNH one zero one two, temperature one eight, dewpoint one two, time four one.",
  ),
  cpRodaje09: tx(
    "cm-cp-rodaje-09-alfa",
    "atc_latam",
    "normal",
    "Aviatory four five two, taxi to holding point runway zero niner via taxiway Alfa, hold short of runway one four, QNH one zero one five.",
  ),
  cpAutColinton: tx(
    "cm-cp-aut-colinton",
    "atc_uk",
    "normal",
    "Aviatory four five two, cleared to Colinton via Bravo two, flight level three three zero, TOLEX two Bravo departure, squawk four six two one.",
  ),
  cpDespegue09: tx(
    "cm-cp-despegue-09-recto",
    "atc_uk",
    "normal",
    "Aviatory four five two, climb straight ahead until four thousand feet before turning left, runway zero niner, cleared for take-off.",
  ),
  cpDetengaRumboSquawk: tx(
    "cm-cp-detenga-rumbo-squawk",
    "atc_latam",
    "sucia",
    "Aviatory four five two, stop descent at flight level one three zero, turn right heading one niner zero, squawk three four seven one.",
  ),
  // 2. Readback
  rbTorre1189: tx("cm-rb-torre-1189", "atc_us", "limpia", "Aviatory four five two, contact Georgetown Tower one one eight decimal niner."),
  rbAscenso110: tx("cm-rb-ascenso-110", "atc_uk", "limpia", "Aviatory four five two, climb to flight level one one zero."),
  rbRumbo160: tx("cm-rb-rumbo-160", "atc_latam", "limpia", "Aviatory four five two, fly heading one six zero."),
  rbReset4215: tx("cm-rb-reset-4215", "atc_us", "limpia", "Aviatory four five two, reset squawk four two one five."),
  rbDescenso3000: tx(
    "cm-rb-descenso-3000",
    "atc_uk",
    "normal",
    "Aviatory four five two, descend to three thousand feet, QNH one zero one seven, transition level six zero, expect ILS approach runway three two.",
  ),
  rbCuandoPase: tx(
    "cm-rb-cuando-pase-080",
    "atc_latam",
    "normal",
    "Aviatory four five two, when passing flight level eight zero contact Alexander Control one two four decimal three five zero.",
  ),
  rbApresureDescenso: tx("cm-rb-apresure-descenso-120", "atc_us", "normal", "Aviatory four five two, expedite descent to flight level one two zero."),
  rbTrasMarlo: tx("cm-rb-tras-marlo-260", "atc_uk", "normal", "Aviatory four five two, after passing Marlo climb to flight level two six zero."),
  rbCruce11: tx("cm-rb-cruce-11", "atc_latam", "normal", "Aviatory four five two, cross runway one one, report vacated."),
  rbInmediata: tx("cm-rb-salida-inmediata", "atc_uk", "normal", "Aviatory four five two, line up. Be ready for immediate departure."),
  rbDespegueViraje34: tx(
    "cm-rb-despegue-34-viraje",
    "atc_us",
    "normal",
    "Aviatory four five two, right turn approved, runway three four, cleared for take-off.",
  ),
  rbCondicionalAtr: tx("cm-rb-condicional-atr", "atc_uk", "normal", "Aviatory four five two, behind the landing ATR, line up and wait behind."),
  rbRegresoPlataforma: tx(
    "cm-rb-regreso-plataforma",
    "atc_latam",
    "sucia",
    "Aviatory four five two, take next right, return to ramp, contact Ground one two one decimal six.",
  ),
  rbPuesto14: tx("cm-rb-puesto-14", "atc_us", "sucia", "Aviatory four five two, taxi to stand one four via taxiway Delta."),
  rbTresSesenta: tx("cm-rb-tres-sesenta-derecha", "atc_latam", "sucia", "Aviatory four five two, make a three sixty turn right for sequencing."),
  // 3. ¿Es para mí? (3): limpia, 542
  e3a: tx("cm-epm3-542-ascenso", "atc_uk", "limpia", "Aviatory five four two, climb to flight level one niner zero."),
  e3b: tx("cm-epm3-452-squawk", "atc_uk", "limpia", "Aviatory four five two, squawk two six one three."),
  e3c: tx("cm-epm3-542-contacto", "atc_uk", "limpia", "Aviatory five four two, contact Alexander Control one two eight decimal seven."),
  e3d: tx("cm-epm3-452-rumbo", "atc_uk", "limpia", "Aviatory four five two, turn right heading one four zero."),
  // ¿Es para mí? (4): normal, 425
  e4a: tx("cm-epm4-425-descenso", "atc_latam", "normal", "Aviatory four two five, descend to flight level one two zero."),
  e4b: tx("cm-epm4-452-notifique-nivel", "atc_latam", "normal", "Aviatory four five two, report level."),
  e4c: tx("cm-epm4-425-rumbo", "atc_latam", "normal", "Aviatory four two five, turn left heading two niner zero."),
  e4d: tx("cm-epm4-452-mantenga", "atc_latam", "normal", "Aviatory four five two, maintain flight level one four zero."),
  e4e: tx("cm-epm4-425-squawk", "atc_latam", "normal", "Aviatory four two five, squawk four seven zero one."),
  // ¿Es para mí? (5): normal, 45, 542 y 425 en la salida
  e5a: tx("cm-epm5-452-rumbo", "atc_us", "normal", "Aviatory four five two, turn left heading zero six zero."),
  e5b: tx("cm-epm5-45-ascenso", "atc_us", "normal", "Aviatory four five, climb to flight level one five zero."),
  e5c: tx("cm-epm5-542-contacto", "atc_us", "normal", "Aviatory five four two, contact Alexander Control one two seven decimal niner."),
  e5d: tx("cm-epm5-452-ascenso", "atc_us", "normal", "Aviatory four five two, climb to flight level one three zero."),
  e5e: tx("cm-epm5-425-apresure", "atc_us", "normal", "Aviatory four two five, expedite climb to flight level one one zero."),
  // ¿Es para mí? (6): normal, torre
  e6a: tx("cm-epm6-452-espere-fuera", "atc_uk", "normal", "Aviatory four five two, hold short of runway two seven."),
  e6b: tx(
    "cm-epm6-425-aterrizaje",
    "atc_uk",
    "normal",
    "Aviatory four two five, runway two seven, cleared to land, wind two five zero degrees one two knots.",
  ),
  e6c: tx("cm-epm6-542-rodaje", "atc_uk", "normal", "Aviatory five four two, taxi to holding point runway two seven via taxiway Bravo."),
  e6d: tx(
    "cm-epm6-425-salida-pista",
    "atc_uk",
    "normal",
    "Aviatory four two five, take first left, when vacated contact Ground one two one decimal eight.",
  ),
  e6e: tx("cm-epm6-452-alineese", "atc_uk", "normal", "Aviatory four five two, line up and wait."),
  // ¿Es para mí? (7): sucia
  e7a: tx("cm-epm7-45-descenso", "atc_latam", "sucia", "Aviatory four five, descend to flight level eight zero."),
  e7b: tx("cm-epm7-452-detenga", "atc_latam", "sucia", "Aviatory four five two, stop descent at flight level one one zero."),
  e7c: tx("cm-epm7-542-rumbo", "atc_latam", "sucia", "Aviatory five four two, turn right heading three three zero."),
  e7d: tx("cm-epm7-452-contacto", "atc_latam", "sucia", "Aviatory four five two, contact Georgetown Approach one one niner decimal five."),
  e7e: tx("cm-epm7-425-apresure", "atc_latam", "sucia", "Aviatory four two five, expedite descent to flight level niner zero."),
  // ¿Es para mí? (8): sucia, la misma instrucción para dos aviones
  e8a: tx("cm-epm8-542-descenso", "atc_us", "sucia", "Aviatory five four two, descend to four thousand feet, QNH one zero zero eight."),
  e8b: tx("cm-epm8-452-rumbo", "atc_us", "sucia", "Aviatory four five two, turn left heading one niner zero."),
  e8c: tx("cm-epm8-425-rumbo", "atc_us", "sucia", "Aviatory four two five, turn left heading one niner zero."),
  e8d: tx("cm-epm8-45-contacto", "atc_us", "sucia", "Aviatory four five, contact Tower one one eight decimal three."),
  e8e: tx("cm-epm8-452-descenso", "atc_us", "sucia", "Aviatory four five two, descend to five thousand feet, QNH one zero zero eight."),
  e8f: tx("cm-epm8-542-reactive", "atc_us", "sucia", "Aviatory five four two, reset squawk one four three two."),
  // 4. Hearback
  h4Atc: tx("cm-hb-squawk-5236", "atc_latam", "limpia", "Aviatory four five two, squawk five two three six."),
  h4Pm: tx("cm-hb-squawk-5236-pm", "piloto_pm", "limpia", "Five two three six, Aviatory four five two."),
  h5Atc: tx("cm-hb-contacto-1321", "atc_us", "limpia", "Aviatory four five two, contact Alexander Control one three two decimal one."),
  h5Pm: tx("cm-hb-contacto-1321-pm", "piloto_pm", "limpia", "One three two decimal seven, Aviatory four five two."),
  h6Atc: tx("cm-hb-derecha-220", "atc_uk", "normal", "Aviatory four five two, turn right heading two two zero."),
  h6Pm: tx("cm-hb-derecha-220-pm", "piloto_pm", "normal", "Left heading two two zero, Aviatory four five two."),
  h7Atc: tx("cm-hb-espere-fuera-29", "atc_latam", "normal", "Aviatory four five two, hold short of runway two niner."),
  h7Pm: tx("cm-hb-espere-fuera-29-pm", "piloto_pm", "normal", "Crossing runway two niner, Aviatory four five two."),
  h8Atc: tx("cm-hb-descenso-6000", "atc_us", "normal", "Aviatory four five two, descend to six thousand feet, QNH one zero two one."),
  h8Pm: tx("cm-hb-descenso-6000-pm", "piloto_pm", "normal", "Descending to flight level six zero, QNH one zero two one, Aviatory four five two."),
  h9Atc: tx("cm-hb-tras-walden-090", "atc_uk", "normal", "Aviatory four five two, after passing Walden descend to flight level niner zero."),
  h9Pm: tx("cm-hb-tras-walden-090-pm", "piloto_pm", "normal", "Descending to flight level niner zero, Aviatory four five two."),
  h10Atc: tx("cm-hb-nueva-aut-290", "atc_latam", "normal", "Aviatory four five two, recleared flight level two niner zero."),
  h10Pm: tx("cm-hb-nueva-aut-290-pm", "piloto_pm", "normal", "Recleared flight level two eight zero, Aviatory four five two."),
  h11Atc: tx(
    "cm-hb-aut-kennington",
    "atc_uk",
    "normal",
    "Aviatory four five two, cleared to Kennington via Alfa two, flight level two six zero, Walden one Charlie departure, squawk three three zero four.",
  ),
  h11Pm: tx(
    "cm-hb-aut-kennington-pm",
    "piloto_pm",
    "normal",
    "Cleared to Kennington via Alfa two, flight level two six zero, Walden one Charlie departure, squawk three three four zero, Aviatory four five two.",
  ),
  h12Atc: tx(
    "cm-hb-aterrizaje-14",
    "atc_us",
    "normal",
    "Aviatory four five two, runway one four, cleared to land, wind one two zero degrees one zero knots.",
  ),
  h12Pm: tx("cm-hb-aterrizaje-14-pm", "piloto_pm", "normal", "Runway one four, cleared to land, Aviatory four five two."),
  h13Atc: tx("cm-hb-despegue-09", "atc_uk", "sucia", "Aviatory four five two, runway zero niner, cleared for take-off."),
  h13Pm: tx("cm-hb-despegue-09-pm", "piloto_pm", "sucia", "Cleared for take-off runway two seven, Aviatory four five two."),
  h14Atc: tx(
    "cm-hb-cuando-pase-1279",
    "atc_latam",
    "sucia",
    "Aviatory four five two, when passing flight level eight zero contact Alexander Control one two seven decimal niner.",
  ),
  h14Pm: tx(
    "cm-hb-cuando-pase-1279-pm",
    "piloto_pm",
    "sucia",
    "When passing flight level eight zero, one two seven decimal niner, Aviatory four two five.",
  ),
  h15Atc: tx(
    "cm-hb-correccion-340",
    "atc_us",
    "sucia",
    "Aviatory four five two, turn left heading three one zero, correction, turn left heading three four zero.",
  ),
  h15Pm: tx("cm-hb-correccion-340-pm", "piloto_pm", "sucia", "Left heading three one zero, Aviatory four five two."),
  // 5. ¿Qué respondes?
  qrRumboNivel: tx("cm-qr-rumbo-y-nivel", "atc_us", "limpia", "Aviatory four five two, report heading and level."),
  qrTodas: tx("cm-qr-todas-las-estaciones", "atc_latam", "limpia", "All stations, Alexander Control, fuel dumping completed."),
  qrObras: tx("cm-qr-obras-puerta-12", "atc_uk", "limpia", "Aviatory four five two, caution construction work adjacent to gate one two."),
  qrTransponder: tx("cm-qr-capacidad-transponder", "atc_us", "limpia", "Aviatory four five two, advise type of transponder capability."),
  qrEstacion: tx("cm-qr-estacion-que-llama", "atc_latam", "normal", "Station calling Georgetown Ground, say again your call sign."),
  qrAtrVista: tx("cm-qr-atr-a-la-vista", "atc_uk", "normal", "Aviatory four five two, report the ATR on final in sight."),
  qrCancele: tx(
    "cm-qr-cancele-despegue",
    "atc_uk",
    "normal",
    "Aviatory four five two, hold position, cancel take-off, I say again, cancel take-off, vehicle on runway.",
  ),
  qrPare: tx("cm-qr-pare-inmediatamente", "atc_us", "normal", "Aviatory four five two, stop immediately, Aviatory four five two, stop immediately."),
  qrApresureRodaje: tx(
    "cm-qr-apresure-rodaje",
    "atc_latam",
    "normal",
    "Aviatory four five two, expedite taxi, traffic on final runway three two, report runway three two vacated.",
  ),
  qrContinue: tx("cm-qr-continue-aproximacion", "atc_uk", "normal", "Aviatory four five two, continue approach, wind one six zero degrees one four knots."),
  qrOmita: tx(
    "cm-qr-omita-notificaciones",
    "atc_latam",
    "normal",
    "Aviatory four five two, omit position reports until FIR boundary, next report Colin.",
  ),
  qrIdentPerdida: tx(
    "cm-qr-identificacion-perdida",
    "atc_us",
    "normal",
    "Aviatory four five two, identification lost due radar failure, contact Alexander Control on one three two decimal three five zero.",
  ),
  qrOrbita: tx("cm-qr-orbita-izquierda", "atc_uk", "normal", "Aviatory four five two, orbit left for delay."),
  qrAltimetro: tx("cm-qr-compruebe-altimetro", "atc_latam", "normal", "Aviatory four five two, check altimeter setting and confirm level."),
  qrTransponderOp: tx("cm-qr-confirme-transponder", "atc_us", "normal", "Aviatory four five two, confirm transponder operating."),
  qrDesconocido: tx(
    "cm-qr-transito-desconocido",
    "atc_uk",
    "normal",
    "Aviatory four five two, unknown traffic two o'clock, four miles, opposite direction, fast moving.",
  ),
  qrContactoAprox: tx("cm-qr-contacto-aproximacion", "atc_us", "normal", "Aviatory four five two, contact Georgetown Approach one two zero decimal four."),
  qrPreveaIls32: tx("cm-qr-prevea-ils-32", "atc_latam", "normal", "Aviatory four five two, expect ILS approach runway three two, QNH one zero one seven."),
  qrQuedeEscucha: tx(
    "cm-qr-quede-en-escucha-torre",
    "atc_us",
    "sucia",
    "Aviatory four five two, stand by for Georgetown Tower one one eight decimal niner.",
  ),
  // 6. Desármala
  dsAscensoApresure: tx(
    ...
    "atc_us",
    "normal",
    "Aviatory four five two, climb to flight level two one zero, expedite until passing flight level one five zero.",
  ),
  dsPasadaBaja: tx(
    "cm-ds-pasada-baja-14",
    "atc_uk",
    "sucia",
    "Aviatory four five two, cleared low pass runway one four, not below five hundred feet, report final.",
  ),
  // 7. Panel
  pnAscenso5000: tx("cm-pn-ascenso-5000", "atc_latam", "limpia", "Aviatory four five two, climb to five thousand feet."),
  pnTerreno: tx("cm-pn-alerta-terreno", "atc_us", "normal", "Aviatory four five two, terrain alert, climb to three thousand feet, QNH one zero zero eight."),
  pnIdentificacion: tx("cm-pn-identificacion-120", "atc_latam", "normal", "Aviatory four five two, for identification turn left heading one two zero."),
  pnEvitar: tx(
    "cm-pn-evitar-transito",
    "atc_uk",
    "sucia",
    "Aviatory four five two, turn left immediately heading two zero zero to avoid traffic one o'clock five miles.",
  ),
  // 8. Ráfaga
  ...
  // 9. ¿Estándar o plain?
  eopVectores: tx("cm-eop-desea-vectores", "atc_us", "normal", "Aviatory four five two, do you want vectors?"),
  // 10. Vuelos completos
  v2Puesta: tx("cm-v2-puesta-en-marcha", "atc_latam", "limpia", "Aviatory four five two, start up approved, QNH one zero one two."),
  v2Rodaje: tx("cm-v2-rodaje-19", "atc_latam", "limpia", "Aviatory four five two, taxi to holding point runway one niner via taxiway Charlie."),
  v2Despegue: tx("cm-v2-despegue-19", "atc_uk", "limpia", "Aviatory four five two, runway one niner, cleared for take-off."),
  v2Salida: tx("cm-v2-contacto-salida", "atc_uk", "limpia", "Aviatory four five two, contact Georgetown Departure one two four decimal eight."),
  v2Ils: tx("cm-v2-ils-directa-14", "atc_us", "limpia", "Aviatory four five two, cleared straight-in ILS approach runway one four, report established."),
  v2Torre: tx("cm-v2-contacto-torre", "atc_us", "limpia", "Aviatory four five two, contact Tower one one niner decimal seven."),
  v3Cruce14: tx("cm-v3-cruce-14", "atc_latam", "normal", "Aviatory four five two, cross runway one four, report vacated."),
  v3Aterrizaje32: tx(
    "cm-v3-aterrizaje-32",
    "atc_us",
    "sucia",
    "Aviatory four five two, runway three two, cleared to land, wind three zero zero degrees one five knots.",
  ),
} satisfies Record<string, Transmision>
...
export const CM_READBACK: EjReadback[] = [
  ...
  // ── Guion completo ──
  {
    ...
    modelo: "One one eight decimal niner, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Climbing to flight level one one zero, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Heading one six zero, Aviatory four five two.",
  ...
  },
  {
    ...
    modelo: "Resetting four two one five, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo:
      "Descending to three thousand feet, QNH one zero one seven, transition level six zero, expecting ILS approach runway three two, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "When passing flight level eight zero, Alexander Control one two four decimal three five zero, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Expediting descent to flight level one two zero, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "After Marlo climb to flight level two six zero, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Crossing runway one one, wilco, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Lining up, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Runway three four, cleared for take-off, right turn, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Behind the landing ATR, line up and wait behind, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Runway one niner, QNH one zero one two, will call for start up, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo:
      "Cleared to Colinton via Bravo two, flight level three three zero, TOLEX two Bravo departure, squawk four six two one, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Next right, return to ramp, one two one decimal six, Aviatory four five two.",
    explicacion:
  ...
  },
  {
    ...
    modelo: "Stand one four via taxiway Delta, Aviatory four five two.",
  ...
  },
  {
    ...
    modelo: "Three sixty turn right, Aviatory four five two.",
    explicacion:
...
export const CM_ES_PARA_MI: EjEsParaMi[] = [
  ...
  },
  {
    ...
    explicacion:
      "Tres parecidos en la misma salida: 45, 542 y 425. El «Aviatory four five» es el más traicionero: suena a tu distintivo cortado. Un distintivo con número de vuelo no se abrevia (Doc 9432 2.7.2.2 c), así que «four five» no eres tú.",
  },
  {
    tipo: "esParaMi",
    id: "e06",
...
export const CM_HEARBACK: EjHearback[] = [
  ...
  },
  {
    ...
    error: "distintivo",
    explicacion:
      "La colación está completa, pero termina con «Aviatory four two five». El controlador puede creer que respondió otro avión. La colación termina con tu distintivo precisamente para eso (Doc 9432 2.8.3.4 y 2.8.3.7).",
  },
  {
    tipo: "hearback",
    id: "h15",
...
export const CM_QUE_RESPONDES: EjQueRespondes[] = [
  ...
  // ── Guion completo ──
  {
    ...
    transmision: G.e4b,
    opciones: [
      "Aviatory four five two, maintaining five thousand feet.",
      "Roger, Aviatory four five two.",
      "Wilco, Aviatory four five two.",
      "Affirm, Aviatory four five two.",
    ],
  ...
  },
  {
    ...
    opciones: [
      "Heading and level, wilco, Aviatory four five two.",
      "Roger, Aviatory four five two.",
      "Aviatory four five two, heading two three zero at six thousand feet.",
      "Aviatory four five two, two three zero, six zero.",
    ],
    correcta: 2,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Roger, Aviatory four five two.",
      "All stations, Aviatory four five two, copied.",
      "Say again, Aviatory four five two.",
  ...
  },
  {
    ...
    opciones: [
      "Wilco, Aviatory four five two.",
      "Holding, Aviatory four five two.",
      "Roger, Aviatory four five two.",
      "Affirm, Aviatory four five two.",
    ],
    correcta: 2,
  ...
  },
  {
    ...
    opciones: [
      "Aviatory four five two, transponder Charlie.",
      "Affirm, Aviatory four five two.",
      "Squawking, Aviatory four five two.",
      "Roger, Aviatory four five two.",
    ],
    correcta: 0,
  ...
  },
  {
    ...
    opciones: [
      "Four five two.",
      "Georgetown Ground, Aviatory four five two.",
      "Say again, Aviatory four five two.",
  ...
  },
  {
    ...
    opciones: [
      "Wilco, Aviatory four five two.",
      "Looking out, Aviatory four five two.",
      "Roger, Aviatory four five two.",
      "Aviatory four five two, ATR in sight.",
    ],
    correcta: 3,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Holding, Aviatory four five two.",
      "Taking off, Aviatory four five two.",
      "Roger, cancel, Aviatory four five two.",
      "Say again, Aviatory four five two.",
    ],
    correcta: 0,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Roger, Aviatory four five two.",
      "Stopping, Aviatory four five two.",
      "Holding short, Aviatory four five two.",
      "Say again, Aviatory four five two.",
    ],
    correcta: 1,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Runway vacated, Aviatory four five two.",
      "Unable, Aviatory four five two.",
      "Expediting, Aviatory four five two.",
      "Roger, report vacated, Aviatory four five two.",
    ],
    correcta: 2,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Aviatory four five two.",
      "Runway one four, cleared to land, Aviatory four five two.",
      "Roger, cleared to land, Aviatory four five two.",
      "Wilco, landing, Aviatory four five two.",
    ],
    correcta: 0,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Roger, next Colin, Aviatory four five two.",
      "Aviatory four five two, wilco.",
      "Affirm, Aviatory four five two.",
      "Negative, Aviatory four five two.",
    ],
    correcta: 1,
  ...
  },
  {
    ...
    opciones: [
      "Negative radar, Aviatory four five two.",
      "Identification lost, wilco, Aviatory four five two.",
      "Say again, Aviatory four five two.",
      "Roger, one three two decimal three five zero, Aviatory four five two.",
    ],
    correcta: 3,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Orbit left, Aviatory four five two.",
      "Holding, Aviatory four five two.",
      "Three sixty right, Aviatory four five two.",
      "Roger, Aviatory four five two.",
    ],
    correcta: 0,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Checked, Aviatory four five two.",
      "Aviatory four five two, altimeter one zero one three, flight level one one zero.",
      "Affirm, Aviatory four five two.",
      "Aviatory four five two, QNH one zero one three, one one thousand feet.",
    ],
    correcta: 1,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Affirm, Aviatory four five two.",
      "Roger, Aviatory four five two.",
      "Aviatory four five two, negative, transponder unserviceable.",
      "Squawking, Aviatory four five two.",
    ],
    correcta: 2,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Traffic in sight, Aviatory four five two.",
      "Looking out, Aviatory four five two.",
      "Roger, Aviatory four five two.",
      "Wilco, Aviatory four five two.",
    ],
  ...
  },
  {
    ...
    opciones: [
      "Approach, go ahead, Aviatory four five two.",
      "Aviatory four five two, with you.",
      "Georgetown Approach, Aviatory four five two, flight level niner zero, estimating North Cross five two, information Echo.",
      "Georgetown Approach, Aviatory four five two, request descent.",
    ],
    correcta: 2,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Runway three two, QNH one zero one seven, request straight-in ILS approach, Aviatory four five two.",
      "Roger, straight-in, Aviatory four five two.",
      "Aviatory four five two, cleared straight-in ILS.",
      "Request straight-in, Aviatory four five two.",
    ],
    correcta: 0,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Roger, Aviatory four five two.",
      "Low pass, Aviatory four five two.",
      "Runway one four, cleared to land, Aviatory four five two.",
      "Runway one four, not below five hundred feet, wilco, Aviatory four five two.",
    ],
    correcta: 3,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Left heading three one zero, Aviatory four five two.",
      "Left heading three four zero, Aviatory four five two.",
      "Correction, Aviatory four five two.",
      "Roger, Aviatory four five two.",
    ],
    correcta: 1,
    explicacion:
  ...
  },
  {
    ...
    opciones: [
      "Georgetown Tower, Aviatory four five two, final.",
      "One one eight decimal niner, Aviatory four five two.",
      "Roger, contacting Tower, Aviatory four five two.",
      "Monitoring, Aviatory four five two.",
    ],
    correcta: 1,
    explicacion:
...
export const CM_ESTANDAR_O_PLAIN: EjEstandarOPlain[] = [
  ...
  // ── Guion completo ──
  {
    ...
    clasificacion: "fraseologia",
    frase: "Georgetown Tower, Aviatory four five two, radio check one one eight decimal niner.",
    explicacion:
  ...
  },
  {
    ...
    clasificacion: "fraseologia",
    frase: "Alexander Control, Aviatory four five two, request time check.",
  ...
  },
  {
    ...
    clasificacion: "fraseologia",
    frase: "Georgetown Tower, Aviatory four five two, request low pass, unsafe left gear indication.",
    explicacion:
  ...
  },
  {
    ...
    clasificacion: "fraseologia",
    frase: "Aviatory four five two, negative vectors, traffic in sight.",
    explicacion:
    ...
    pasos: [
      ...
      { fase: "Autorización", perfil: "limpia", ejercicio: delId(CM_COPIA, "c08") },
      {
        ...
        ejercicio: {
          ...
          modelo: "Start up approved, QNH one zero one two, Aviatory four five two.",
      ...
      },
      {
        ...
        ejercicio: {
          ...
          modelo: "Via Charlie, holding point runway one niner, Aviatory four five two.",
      ...
      },
      {
        ...
        ejercicio: {
          ...
          modelo: "Runway one niner, cleared for take-off, Aviatory four five two.",
      ...
      { fase: "Llegada", perfil: "limpia", ejercicio: delId(CM_COPIA, "c05") },
      {
        ...
        ejercicio: {
          ...
          modelo: "Cleared straight-in ILS approach runway one four, wilco, Aviatory four five two.",
    ...
    pasos: [
      ...
      { fase: "Rodaje", perfil: "normal", ejercicio: delId(CM_COPIA, "c07") },
      {
        ...
        ejercicio: {
          ...
          modelo: "Crossing runway one four, wilco, Aviatory four five two.",
      ...
      { fase: "Llegada", perfil: "sucia", ejercicio: delId(CM_READBACK, "r08") },
      {
        ...
        ejercicio: {
          ...
          modelo: "Runway three two, cleared to land, Aviatory four five two.",
