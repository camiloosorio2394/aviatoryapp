...
/**
 * Una nota sobre el banco. En tinta neutra, salvo la que avisa de verdad: que
 * el banco oficial tiene errores es una advertencia sobre la fuente, y va en
 * ámbar. Que las preguntas estén verificadas no es un acierto de nadie, así que
 * ya no va en verde.
 */
function Nota({
  icon: Icon,
