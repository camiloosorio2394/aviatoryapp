 ...
 * propio es el acento, que aquí es el azul pizarra, y que todavía no hay fotos:
 ...
 *
 * La práctica no tiene puerta propia: las preguntas de cada unidad viven al
 * final de la unidad, y la fila de avance de práctica lleva a la primera.
 */

const ACENTO = "var(--av-rc-700)"
  ...
  const partes: CourseCardProps[] = [
    {
      ...
      title: "1. Aprende",
      blurb:
        "Los reglamentos que te preguntan, uno por uno: licencias y médico, reglas de vuelo, la aerolínea, seguridad y las consecuencias sobre tu licencia.",
      cta: "Iniciar formación",
      photoHueco:
        "RAC-HUB-01 · Portada · 5:2 · 1200×480 · Licencia de piloto y certificado médico sobre la mesa de despacho, junto al manual de operaciones",
      status:
    ...
    },
    {
      ...
      title: "2. Evalúate",
      blurb:
        "Cincuenta preguntas sobre las diecinueve unidades; cada intento toma veinte al azar. El resultado dice qué RAC repasar.",
      cta: "Presentar la evaluación",
      photoHueco:
        "RAC-HUB-02 · Portada · 5:2 · 1200×480 · Piloto revisando la carpeta de reglamentos antes de una entrevista técnica",
  ...
  return (
    <div className="@container notam-hub px-5 sm:px-8 py-9 sm:py-11 pb-24 max-w-[1600px] mx-auto">
      ...
      {/* Sin foto todavía: el navy liso es la base del hero de todos los módulos
          y aguanta solo hasta que exista RAC-HUB-00. */}
        ...
        <div className="relative grid gap-7 px-7 pb-7 pt-7 sm:px-12 sm:pb-8 sm:pt-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,248px)] lg:gap-10">
          <div className="min-w-0">
            ...
            <p className="mt-4 max-w-[56ch] text-[16px] leading-[1.55] text-white/80">
              {RAC_TITULO_LARGO}: las diecinueve normas que de verdad te tocan como piloto de
              aerolínea, con el numeral al lado de cada dato para que puedas ir a la fuente.
            </p>
                ...
                <>
                  ...
                  >
                    <div
                      ...
                      style={{ width: `${resumen.overall}%`, background: "var(--av-rc-500)" }}
                    />
                  </div>
                </>
              )}
