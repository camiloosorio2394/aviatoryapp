...
describe("ImagenPsicoAmpliable", () => {
  it("mantiene la lámina y permite ampliarla y volver a ajustarla", () => {
    ...
    expect(contenedor.textContent).toContain("Desliza la lámina para recorrerla")
    act(() => boton.click())
    expect(boton.getAttribute("aria-expanded")).toBe("false")
    expect(contenedor.textContent).not.toContain("Desliza la lámina para recorrerla")
  })
})
