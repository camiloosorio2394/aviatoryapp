...
/**
 * Algo falló con la tanda: qué pasó, en palabras del piloto, y qué hacer.
 * `acciones` son los botones; el mensaje nunca es el error técnico.
 */
export function PsicoError({ titulo, mensaje, acciones }: { titulo: string; mensaje: string; acciones: ReactNode }) {
  return (
