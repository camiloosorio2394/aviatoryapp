-- ============================================================================
-- El panel conoce los tres módulos, no uno.
--
-- `panel_tarjetas()` devolvía el avance de NOTAM y nada más. Meteorología y
-- Mercancías están terminados en la app (video, lecciones, práctica y
-- evaluación), pero un piloto que iba por cualquiera de los dos abría su
-- pantalla de inicio y no veía su avance por ningún lado: el panel anunciaba
-- un tercio del contenido que ya existe.
--
-- Los ayudantes `secciones_leidas` y `practicas_hechas` ya recibían el módulo
-- por parámetro, así que esto es agregar dos bloques con la misma forma. El de
-- `notam` no se toca: el cliente que ya lo lee sigue igual.
--
-- No toca filas.
-- ============================================================================
