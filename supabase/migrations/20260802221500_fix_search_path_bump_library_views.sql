-- Segunda aplicación que registró la base, con el mismo contenido que
-- 20260802040000_fix_search_path_bump_views.sql. Se conserva para que el historial del repo sea el de la
-- base; volver a correrla no cambia nada.
-- ============================================================================
