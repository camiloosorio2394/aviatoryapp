...
--
-- ORDEN: va DESPUÉS de todo lo que hay en main: de 20260929120000 (PBN, la
-- última aplicada en producción) y de 20260930000000 (el tema de la
-- evaluación, que está en main y puede estar pendiente). No depende de ellas
-- (solo usa modulos_contenido, module_thresholds y
...
-- Se escribió como 20260928000000 y se renumeró al traer RAC, Combustible,
-- RVSM y PBN de main.
--
