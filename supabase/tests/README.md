...
| `logros.sql` | Lección y práctica contra el catálogo (NOTAM, Aeropuertos y Comunicaciones ATC), claves viejas que no cuentan, un grupo por disparador, ponerse al día solo sobre sí mismo. Desde el caso de Aeropuertos necesita `20260916000000` aplicada, y desde el de Comunicaciones, `20260925020000`. |
