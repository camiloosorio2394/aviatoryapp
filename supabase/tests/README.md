...
| `comunicaciones.sql` | Progreso de Comunicaciones ATC contra su catálogo (69 lecciones, ninguna práctica todavía), RPC idempotente y `security definer`, RLS, sin escritura directa ni sin sesión, `anon` sin nada, y que los otros módulos conservan su catálogo. Con `20260925000000` aplicada. |
